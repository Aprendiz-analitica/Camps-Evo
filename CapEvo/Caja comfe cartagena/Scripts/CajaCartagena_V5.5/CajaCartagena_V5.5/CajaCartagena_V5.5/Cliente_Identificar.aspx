...
<%
    If Request("idsujeto") <> "0" Then
        Gestion.CargaCliente(Convert.ToInt64(Gestion.Cliente.IdSujeto))
        EvoAPI.LoadCustomer(Convert.ToInt64(Gestion.Cliente.IdSujeto))
    Else
...
<script type="text/javascript">
    ...
    agentapi.SetCustomer(<%= Gestion.Transaccion.IdTransaccion %> , <%= Gestion.Cliente.IdSujeto %>)
        .done(function () { window.location.href='Finales.aspx'; });
