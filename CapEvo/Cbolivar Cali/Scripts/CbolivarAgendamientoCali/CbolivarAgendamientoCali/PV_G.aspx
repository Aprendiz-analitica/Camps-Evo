    ...
    <table class="formulario" style="width:75%;">          
        ...
        <tbody>            
            ...
            <tr>
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
                    Motivo:<br />
                    <asp:DropDownList ID="t3" runat="server" ForeColor="Black" 
                        Width="94%">
                        <asp:ListItem></asp:ListItem>
            ...
            <tr>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
                    Momento:<br />
                    <asp:DropDownList ID="t4" runat="server" ForeColor="Black" Width="94%">
                        <asp:ListItem></asp:ListItem>
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
                    Razon:<br />
                    <asp:DropDownList ID="t6" runat="server" ForeColor="Black" Width="94%">
                        <asp:ListItem></asp:ListItem>
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
                    Actividad (SAC):<br />
                    <asp:DropDownList ID="t7" runat="server" ForeColor="Black" Width="94%">
                        <asp:ListItem></asp:ListItem>
