...
<%
    ...
    If Not String.IsNullOrWhiteSpace(Extension) Then
        ...
        Using client As New Icr.Comun.ICR.Ami.AmiClient("30.10.6.150", 5038, "evolution", "bomber")
            ...
            If client.ChanSpy(Icr.Comun.ICR.Ami.AmiClient.ChanSpyMode.Barge, "local/2006*00" + Gestion.Transaccion.IdTransaccion.ToString + "@from-internal", "SIP/" + Extension + "-", True) Then
