  ...
  $(document).ready(function() {
    ...
    var settings = {
           ...
           $.ajax(settings).done(function (response) {
                ...
                var temp;
                var actividades = {
                  "url": url+"/webservicefenalco/cbolivarbgta/consultaractividadpormaestroesp",
                  "method": "POST",
                  "timeout": 0,
                  "headers": {
                ...
                $.ajax(actividades).done(function (response) {
                    ...
                    $.each(temp, function(key, value) {
                          $('#Razon').append('<option value=' + value.idActividad + '>' + value.descripcion + '</option>');
                        });
                });
            });        
	}); 

    function llenarmotivonoleinteresa(idActividad) {
                $('#motnointeresa option').remove();
                var temp;
                var razones = {
                  "url": url+"/webservicefenalco/cbolivarbgta/consultarrazonpormaestroesp",
                  "method": "POST",
                  "timeout": 0,
                  "headers": {
                    "Authorization": "Bearer "+ token,
                ...
                $.ajax(razones).done(function (response) {
                    ...
                    if (temp != null ) {
                        ...
                        $('#motnointeresa').append('<option value= 0 > Seleccione motivo de desinteres </option>'); 
                        $.each(temp, function(key, value) {
                          $('#motnointeresa').append('<option value=' + value.idRazon + '>' + value.descripcion + '</option>');
                        });
                    }
                    else{ return false;}
                });
    ...
    function insertarpqrs() {
            ...
            var motivonointeresa = $("#motnointeresa option:selected").text();
            ...
            if (razon == '' || $("#Razon option:selected").val() == 0) {
                    alert("Por favor seleccione Razon");
                    return false;
                }
            if (motnointeresa == '' || $("#motnointeresa option:selected").val() == 0) {
                    alert("Por favor seleccione motivo de desinteres");
                    return false;
                }
            var settings = {
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="formulario" style="width:75%;">       
        <thead>
            <tr>
                <th style="border: 1px solid #249E6B ; text-align:center; background-color: #249E6B ; font-size: 20px; color: #FFFFFF; font-weight: bold;" colspan="3" align="center">
        ...
        <tbody>            
            <tr>
                <td style="border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
            ...
            <tr>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
                    Origen caso:<br />
                    <asp:DropDownList ID="t1" runat="server" ForeColor="Black" Width="94%">
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
                    ...
                    <asp:DropDownList ID="t2" runat="server" ForeColor="Black" Width="94%">
                        <asp:ListItem></asp:ListItem>
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
                    Razon:<br />
                    <select name="idRazon" id="Razon" onchange="llenarmotivonoleinteresa(this.value)" 
            ...
            <tr>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
                    <select name="idmotnointeresa" id="motnointeresa" class = "motivonointeresa" 
                        style="visibility: hidden;color: #000000; width: 94%;">
                    </select>
                </td>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
            ...
            <tr>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
                    Proyecto:<br />
                    <asp:DropDownList ID="Proyecto" runat="server" ForeColor="Black" Width="94%">
                                <asp:ListItem></asp:ListItem>
                                ...
                                <asp:ListItem Value="VIBRATTO">VIBRATTO</asp:ListItem>
                                </asp:DropDownList>
                    <br />
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
                    Agrupacion:<br />
                    <asp:TextBox ID="Agrupacion" runat="server" ForeColor="Black" Width="94%"></asp:TextBox>
                    <br />
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
                    Producto:<br />
                    <asp:TextBox ID="Producto" runat="server" ForeColor="Black" Width="94%"></asp:TextBox>
                    <br />
            ...
            <tr>
                ...
                colspan="3">
                    ...
                    <asp:DropDownList ID="Sedes" runat="server" ForeColor="Black" Width="94%">
                                            <asp:ListItem></asp:ListItem>
            ...
            <tr>
                ...
                colspan="3">
                    Descripcion:<br />
                    <asp:TextBox ID="Descripcion" runat="server" Width="94%" ForeColor="Black" 
            ...
            <tr>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
                    <input id="Button9" type="button" value="Finalizar" onclick="insertarpqrs()" 
                        ...
                        style="border: 1px solid #249E6B ; color: #FFFFFF; font-size: 16px; background-color: #249E6B ; width: 160px; height: 60px; background-image: none; white-space: normal;" /></td>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
                    <input id="Button10" type="button" value="Guardar y continuar" onclick="insertarpqrsgyc()" 
                        
                        style="border: 1px solid #249E6B ; color: #FFFFFF; font-size: 16px; background-color: #249E6B ; width: 160px; height: 60px; background-image: none; white-space: normal;" />
                </td>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #249E6B ; color: #249E6B ; font-weight: bold; font-size: 16px;">
