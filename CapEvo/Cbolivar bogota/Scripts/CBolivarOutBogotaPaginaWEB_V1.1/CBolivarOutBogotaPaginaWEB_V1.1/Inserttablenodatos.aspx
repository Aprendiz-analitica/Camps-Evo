...
<%
    ...
    Dim tip2 As String = "NO BRINDA DATOS"
    Dim tip3 As String = ""
    Select Case tipificacion
        Case "106"
            tip3 = "EQUIVOCADO"
        Case "112"
            tip3 = "LLAMADA CORTADA"
        Case "104"
            tip3 = "LLAMADA MUDA"
    End Select
    ...
    sqlComm.CommandText = "INSERT INTO __tipCbolivarbgta_sac_pqrs(idtransaccion,numdoc,name,name2,lastname,lastname2,t1,t2,t3) VALUES ('" + idcall + "','" + idoriginal + "','" + Nombre1 + "','" + Nombre2 + "','" + Apellido1 + "','" + Apellido2 + "','" + tip1 + "','" + tip2 + "','" + tip3 + "')"
