...
<%
    ...
    sqlComm.CommandText = "INSERT INTO __tipCbolivarbgta_sac_pqrs(idtransaccion,numdoc,name,name2,lastname,lastname2,t1,t2,t3,t4,t5,t6,t7,t8,Descripcion,checkcomunicado,sede) VALUES ('" + idcall + "','" + idoriginal + "','" + Nombre1 + "','" + Nombre2 + "','" + Apellido1 + "','" + Apellido2 + "','" + tip1 + "','" + tip2 + "','" + tip3 + "','" + tip4 + "','" + tip5 + "','" + tip6 + "','" + tip7 + "','" + tip8 + "','" + descripcio + "','" + check + "','" + sede + "')"
