...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
  ...
  $(document).ready(function() {
    ...
    function llenarMicro(idMacro) {
                $('#Micro option').remove();
                if (idMacro == '1' || $("#Macro option:selected").val() == 1) {
                    $('#Micro').append('<option value= 0 > Seleccione tipificación Micro </option>');
                    $('#Micro').append('<option value= 1 >Fisico</option>'); 
                    $('#Micro').append('<option value= 2 >Virtual</option>');
                    $('#Micro').append('<option value= 15 >Ilocalizado</option>');  
                } else if (idMacro == '2' || $("#Macro option:selected").val() == 2) {
                    $('#Micro').append('<option value= 0 > Seleccione tipificación Micro </option>');
                    $('#Micro').append('<option value= 1 >Fisico</option>'); 
                    $('#Micro').append('<option value= 2 >Virtual</option>');
                    $('#Micro').append('<option value= 15 >Ilocalizado</option>');  
                } else if (idMacro == '3' || $("#Macro option:selected").val() == 3) {
                    $('#Micro').append('<option value= 0 > Seleccione tipificación Micro </option>');
                    $('#Micro').append('<option value= 3 >Acta de Entrega</option>');
                    $('#Micro').append('<option value= 4 >Otro Si Comodato PQ</option>');
                    $('#Micro').append('<option value= 5 >Escrituras</option>');
                    $('#Micro').append('<option value= 15 >Ilocalizado</option>'); 
                } else if (idMacro == '4' || $("#Macro option:selected").val() == 4) {
                    $('#Micro').append('<option value= 0 > Seleccione tipificación Micro </option>');
                    $('#Micro').append('<option value= 6 >Recoger Llaves</option>');
                    $('#Micro').append('<option value= 7 >Espera de Llaves</option>');
                    $('#Micro').append('<option value= 8 >Pre-Entrega</option>');
                    $('#Micro').append('<option value= 9 >Adelantos</option>');
                    $('#Micro').append('<option value= 15 >Ilocalizado</option>'); 
                } else if (idMacro == '5' || $("#Macro option:selected").val() == 5) {
                    $('#Micro').append('<option value= 0 > Seleccione tipificación Micro </option>');
                    $('#Micro').append('<option value= 10 >Pendiente Arreglos</option>');
                    $('#Micro').append('<option value= 11 >Pendiente Firma Escritura</option>');
                    $('#Micro').append('<option value= 12 >Pendiente Llaves Cajilla</option>');
                    $('#Micro').append('<option value= 13 >Caso Especial</option>');
                    $('#Micro').append('<option value= 15 >Ilocalizado</option>'); 
                } else if (idMacro == '6' || $("#Macro option:selected").val() == 6) {
                    $('#Micro').append('<option value= 0 > Seleccione tipificación Micro </option>');
                    $('#Micro').append('<option value= 14 >Subsidios</option>');
                    $('#Micro').append('<option value= 15 >Ilocalizado</option>'); 
                }
    ...
    function finalizar() {
            ...
            var tipmacro = $("#Macro option:selected").text();
            var tipmicro = $("#Micro option:selected").text();
            var idfinal = $("#Outbound option:selected").val();
            var desfinal = $("#Outbound option:selected").text();

            if  (tipmacro == '' || $("#Macro option:selected").val() == 0) {
                    alert("Tipifiacion Macro esta vacio y es obligatorio");
                    return false;             
                } else if (tipmicro == '' || $("#Micro option:selected").val() == 0) {
                    alert("Tipifiacion Micro esta vacio y es obligatorio");
                    return false;
                } else if (desfinal == '' || $("#Outbound option:selected").val() == 0) {
                    alert("Tipifiacion Outbound esta vacio y es obligatorio");
                    return false;
                }
            var settings = {
        ...
        <tbody>
                ...
                <td style="padding: 5px; border-style: solid; border-width: 1px; border-color: #ed7203; color: #249e6b ; font-weight: bold; font-size: 14px; width: 201px; vertical-align: middle;" 
                    ...
                    Fecha de asignacion:<evo:DatosCliente_TextBox ID="DatosCliente_TextBox7" runat="server" 
                        ...
                        LabelStyle-Font-Bold="True" ValueStyle-ForeColor="Black" 
                        ValueStyle-Width="85%" Enabled="False" TipoTextBox="Date" />
                ...
                <td style="border: 1px solid #ed7203; padding: 5px; color: #249e6b; font-weight: bold; font-size: 14px; vertical-align: middle; text-align: center;" 
                    ...
                    <input id="Button5" onclick="Llamar()" 
                        ...
                        type="button" value="LLAMAR" onclick="return Button5_onclick()" onclick="return Button5_onclick()" /></td>
                    </tr>
        </tbody>
    </table>
    <table class="formulario" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                <td class="style4" 
                    ...
                    Tipificación Macro:
                    <select id="Macro" name="idMacro" style="width: 100%" onchange="llenarMicro(this.value)">
                    <option value= '0' ></option>
                    <option value= '1' >Agendamiento</option>
                    <option value= '2' >Reprogramación</option>
                    <option value= '3' >Firmas</option>
                    <option value= '4' >Recordatorio</option>
                    <option value= '5' >Gestión Especial</option>
                    <option value= '6' >Actualización de Datos</option>
                    </select></td>
            </tr>
            <tr>
                <td class="style4" 
                    ...
                    style="border: 1px solid #ed7203; padding: 5px; color: #249e6b; font-weight: bold; font-size: 14px; vertical-align: middle;">
                    Tipificación Micro:
                    <select id="Micro" name="idMicro"  style="width: 100%">
            ...
            <tr>
                <td class="campoti" style="text-align: center" >
                    ...
                    <asp:HiddenField ID="nameproyecto" runat="server" />
                    <asp:HiddenField ID="nameproceso" runat="server" />
                    <asp:HiddenField ID="ididentificacion" runat="server" />
                    <br />
