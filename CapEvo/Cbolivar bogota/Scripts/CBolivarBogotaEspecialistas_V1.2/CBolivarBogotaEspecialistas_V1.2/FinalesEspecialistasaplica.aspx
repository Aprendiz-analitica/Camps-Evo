  ...
  $(document).ready(function() {
    ...
    var settings = {
           ...
           $.ajax(settings).done(function (response) {
            ...
            var momentos = {
                        "url": url+"/webservicefenalco/cbolivarbgta/listadomomentosespora",
                        "method": "POST",
                        "timeout": 0,
                        "headers": {
    ...
    function llenarNecesidad(idMomento) {
                ...
                var temp;
                var necesidades = {
                  "url": url+"/webservicefenalco/cbolivarbgta/consultarnecesidadpormaestroespora",
                  "method": "POST",
                  "timeout": 0,
                  "headers": {
                    "Authorization": "Bearer "+ token,
    ...
    function llenarActividad(idNecesidad) {
                ...
                var temp;
                var actividades = {
                  "url": url+"/webservicefenalco/cbolivarbgta/consultaractividadpormaestroespora",
                  "method": "POST",
                  "timeout": 0,
                  "headers": {
                    "Authorization": "Bearer "+ token,
    ...
    function llenarRazon(idActividad) {
                ...
                var temp;
                var razones = {
                  "url": url+"/webservicefenalco/cbolivarbgta/consultarrazonpormaestroespora",
                  "method": "POST",
                  "timeout": 0,
                  "headers": {
                    "Authorization": "Bearer "+ token,
	...
	function insertarpqrs() {
            ...
            var idoriginal = $("#<%= numerodoc.ClientID %>").val();
            ...
            if (momento == '' || $("#Momento option:selected").val() == 0) {
                    ...
                    return false;
                } else if (actividad == '' || $("#Actividad option:selected").val() == 0) {
                    alert("El campo Actividad esta vacio y es obligatorio");
                    return false;
                } else if (razon == '' || $("#Razon option:selected").val() == 0) {
                    alert("El campo Razon esta vacio y es obligatorio");
                    return false;
                }
            var settings = {
    ...
    <table class="formulario" style="width:70%;">        
        <tbody>  
            ...
            <tr>
                ...
                <td style="border: 1px solid #ed7203; padding: 5px; text-align:center; vertical-align: middle; font-weight: bold; font-size: 14px; color: #249e6b;" colspan="2">
                    Primer nombre:<br />
            ...
            <tr>
                <td style="border: 1px solid #ed7203; padding: 5px; text-align:center; vertical-align: middle; font-weight: bold; font-size: 14px; color: #249e6b;" colspan="4">
            ...
            <tr>
                <td style="border: 1px solid #ed7203; padding: 5px; text-align:center; vertical-align: middle; font-weight: bold; font-size: 14px; color: #249e6b;" colspan="4">
                    <input id="Button12" type="button" value="Consultar" onclick="showdescripcion()"                         
                        style="font-size: 14px; background-color: #249E6B; width: 200px; height: 40px; background-image: none; font-weight: bold; margin-right: 0; color: #FFFFFF; border: 1px solid transparent; border-radius: 4px;"/></td>
            ...
            <tr>
                <td style="padding: 10px; border: 1px solid #ed7203;  color: #249e6b; font-size: 16px; font-weight: bold;" 
                    colspan="4">
                    Momento:<br />
            ...
            <tr>
                <td style="padding: 10px; border: 1px solid #ed7203;  color: #249e6b; font-size: 16px; font-weight: bold;" 
                    ...
                    <asp:HiddenField ID="numerodoc" runat="server" />
