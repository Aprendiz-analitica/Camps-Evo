...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="formulario" style="width:70%;">        
        ...
        <tbody>            
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #f8db66; height:50px; background-color: #28a745; color: #f8db66; font-weight: bold; font-size: 16px; ">
                    Origen caso:<br />
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #f8db66; background-color: #28a745; color: #f8db66; font-weight: bold; font-size: 16px; height: 50px;">
                    Proyecto:<br />
            ...
            <tr>
                ...
                <td style="padding: 10px; border: 2px solid #f8db66; text-align:center; background-color: #28a745; color: #f8db66; font-weight: bold; font-size: 16px;" 
                    ...
                    <asp:Button ID="Button4" runat="server" Text="GUARDAR Y CONTINUAR" 
                        OnClick ="insertsacpqrs_gyc" BackColor="#28A745" BorderColor="#F8DB66" 
                        BorderStyle="Solid" Font-Bold="True" Font-Size="16px" ForeColor="#F8DB66"  
                        style="white-space:normal;" Height="50px" Width="150px" />
                </td>
            </tr>
            <tr>
                <td style="padding: 10px; border: 2px solid #f8db66; text-align:center; height:50px; background-color: #28a745; color: #f8db66; font-weight: bold; font-size: 16px;" 
                    colspan="2">
                ...
                <td style="padding: 10px; border: 2px solid #f8db66; text-align:center; height:50px; background-color: #28a745; color: #f8db66; font-weight: bold; font-size: 16px;" 
                    ...
                    <asp:Button ID="Button3" runat="server" Text="ENCUESTA"  BackColor="#28A745" BorderColor="#F8DB66" 
                        BorderStyle="Solid" Font-Bold="True" Font-Size="16px" ForeColor="#F8DB66" 
                        Height="50px" Width="150px" OnClientClick="Transf_Encuesta()" />
                </td>
            </tr>
        </tbody>
    </table>
