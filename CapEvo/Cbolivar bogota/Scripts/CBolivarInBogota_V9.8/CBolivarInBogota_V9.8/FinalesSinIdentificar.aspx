            ...
            <tr>
                <td class="campoti" style="text-align: center">
                    <evo:GuardarDatosCliente_Button ID="GuardarDatosCliente_Button1" runat="server" 
                        ...
                        Destino="~/TipificacionesSinIdentificar.aspx" Font-Bold="True" Font-Size="14px" 
                        ForeColor="White" Height="42px" Text="BOLIVAR INBOUND" Width="200px" />
                </td>
                <td class="campoti" style="text-align: center">
...
<script runat="server">
    ...
    Protected Sub fundacion(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Response.Redirect("~/Fundacion.aspx?tipificacion=" + tipificacion)
    End Sub
