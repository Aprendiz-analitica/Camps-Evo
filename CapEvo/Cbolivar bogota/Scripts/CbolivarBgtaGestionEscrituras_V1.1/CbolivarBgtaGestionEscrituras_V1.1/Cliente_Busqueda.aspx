...
<script>
    $(document).ready(function () {
      ...
      document.getElementById("ctl00_MainContent_fechaasignacionevo").type = "date";
	});
</script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="style1" style="border: 1px solid #249E6B ">
        ...
        <tr>
            <td style="padding: 5px; border: 1px solid #249E6B; color: #249E6B; font-weight: bold; font-size: 16px; text-align: center; width: 201px;">
                Documento<br />
            ...
            <td style="padding: 5px; border: 1px solid #249E6B; color: #249E6B; font-weight: bold; font-size: 16px; text-align: center; width: 201px;">
                Fecha de asignacion<br />
                <asp:TextBox ID="fechaasignacionevo" runat="server" 
                    BorderStyle="Groove" TabIndex="1" 
                    Width="90%" ForeColor="Black"></asp:TextBox>
            </td>
        ...
        <td width="10%" 
                ...
                <asp:Button ID="Buscar" runat="server" onclick="Buscar_OnClick" 
                    ...
                    BorderColor="#249E6B " Height="30px" />
            </td>
            <td width="10%" 
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="NOMBRE" HeaderText="Nombre Completo">
                <ControlStyle Font-Size="16px" />
                <HeaderStyle BackColor="#ed7203" Font-Bold="True" ForeColor="White" 
                    HorizontalAlign="Center" Width="40%" />
            </asp:BoundField>
            <asp:BoundField DataField="TEXTO1" HeaderText="Fecha de asignacion">
                <ControlStyle Font-Size="16px" />
                <HeaderStyle BackColor="#ed7203" Font-Bold="True" ForeColor="White" 
...
<script runat="server">
    ...
    Protected Sub Buscar_OnClick(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        sSql = "select top 30 C.IDSUJETO, C.NOMBRE,C.sNombreCompleto,C.APELLIDO1,C.APELLIDO2, C.TELEFONO,C.IDORIGINAL,C.TEXTO1"
        ...
        If (Not String.IsNullOrEmpty(numdocevo.Text)) Then
            sWhere = sWhere + " AND C.IDORIGINAL LIKE '%" + numdocevo.Text + "%'"
        End If 
        If (Not String.IsNullOrEmpty(telefonoevo.Text)) Then
            sWhere = sWhere + " AND C.Telefono LIKE '%" + telefonoevo.Text + "'"
        End If
        If (Not String.IsNullOrEmpty(fechaasignacionevo.Text)) Then
            sWhere = sWhere + " AND C.TEXTO1 = '" + fechaasignacionevo.Text + "'"
        End If
    ...
    Protected Sub Nuevo_OnClick(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim doc_fechasignacion = numdocevo.Text
        Dim doc_fechasignacion_date = fechaasignacionevo.Text
        Response.Redirect("Cliente_Alta.aspx?doc_fechasignacion=" + doc_fechasignacion + "&doc_fechasignacion_date=" + doc_fechasignacion_date)
