...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <table class="formulario" style="width:70%;">        
        ...
        <tbody>            
            <tr>
                <td style="border: 2px solid #ed7203; padding:5px 10px; font-weight: bold; font-size: 16px; width: 200px;" 
                    class="style3">
            ...
            <tr>
                ...
                <td 
                    style="border: 2px solid #ed7203; padding:5px 10px; font-weight: bold; font-size: 16px; width: 200px;" 
                    class="style3" colspan="2">
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203; height:50px; color: #249E6B; font-weight: bold; font-size: 16px; ">
                    Origen caso:<br />
                ...
                <td style="padding: 10px; border: 2px solid #ed7203; height:50px; color: #249E6B; font-weight: bold; font-size: 16px; " 
                    ...
                    <asp:DropDownList ID="t2" runat="server" ForeColor="Black" Width="250px">
                        <asp:ListItem></asp:ListItem>
                ...
                <td style="padding: 10px; border: 2px solid #ed7203; height:50px; color: #249E6B; font-weight: bold; font-size: 16px; ">
                    Razon:<br />
                    <asp:DropDownList ID="t6" runat="server" ForeColor="Black" Width="250px">
                    <asp:ListItem></asp:ListItem>
                        <asp:ListItem Value="Agendado a sala de venta">Agendado a sala de venta</asp:ListItem>
                        <asp:ListItem>Agendado llamada comercial</asp:ListItem>
                        <asp:ListItem Value="Campana expectativa">Campaña expectativa</asp:ListItem>
                        <asp:ListItem Value="Compras en el exterior">Compras en el exterior</asp:ListItem>
                        <asp:ListItem Value="Interesado en proyectos de Cali">Interesado en proyectos de Cali</asp:ListItem>
                        <asp:ListItem Value="No le interesa">No le interesa</asp:ListItem>
                        <asp:ListItem>Vendenos tu Lote</asp:ListItem>
                    </asp:DropDownList>
                    <br />
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203; color: #249E6B; font-weight: bold; font-size: 16px; height: 50px;">
                    Proyecto:<br />
...
<asp:ListItem Value="BOSQUES DEL RIO NEGRO - BOSQUES ROBLEDAL">BOSQUES DEL RIO NEGRO - BOSQUES ROBLEDAL</asp:ListItem>
                ...
                <td style="padding: 10px; border: 2px solid #ed7203; color: #249E6B; font-weight: bold; font-size: 16px; height: 50px;" colspan="2">
                    Agrupacion:<br />
...
<asp:ListItem Value="Parques de Bolivar Barranquilla">Parques de Bolivar Barranquilla </asp:ListItem>
            ...
            <tr>
                ...
                <td style="padding: 10px; border: 2px solid #ed7203; text-align:center; color: #ed7203; font-weight: bold; font-size: 16px;" 
                    colspan="2" class="style9">
                    <asp:Button ID="Button4" runat="server" Text="GUARDAR Y CONTINUAR" 
                        OnClick ="insertsacpqrs_gyc" BackColor="#249E6B" BorderColor="#249E6B" 
                        BorderStyle="Solid" Font-Bold="True" Font-Size="16px" ForeColor="#fffffff"  
                        style="white-space:normal;" Height="50px" Width="220px" />
                </td>
            </tr>
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203; text-align:center; height:50px;  color: #ed7203; font-weight: bold; font-size: 16px;" 
                    colspan="2">
...
<script runat="server">
    ...
    Protected Sub insertsacpqrs(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Response.Redirect("~/Inserttablecomer.aspx?idoriginal=" + idoriginal + "&Nombre1=" + Nombre1 + "&Nombre2=" + Nombre2 + "&Apellido1=" + Apellido1 + "&Apellido2=" + Apellido2 + "&tip1=" + tip1 + "&tip2=" + tip2 + "&tip6=" + tip6 + "&proyect=" + proyect + "&agrupacio=" + agrupacio + "&product=" + product + "&descripcio=" + descripcio + "&tipificacion=" + tipificacion + "&sede=" + sede)
    End Sub
    ...
    Protected Sub insertsacpqrs_gyc(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        product = Producto.Text
        descripcio = Descripcion.Text
        Response.Redirect("~/Inserttablecomer_gyc.aspx?idoriginal=" + idoriginal + "&Nombre1=" + Nombre1 + "&Nombre2=" + Nombre2 + "&Apellido1=" + Apellido1 + "&Apellido2=" + Apellido2 + "&tip1=" + tip1 + "&tip2=" + tip2 + "&tip6=" + tip6 + "&proyect=" + proyect + "&agrupacio=" + agrupacio + "&product=" + product + "&descripcio=" + descripcio + "&tipificacion=" + tipificacion + "&sede=" + sede)
    End Sub
</script>
