...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
  ...
  $(document).ready(function() {
    ...
    function llenarEnvioCierre(idEstadoGarantia) {
                $('#EnvioCierre option').remove();
                $("#trEnvioCierre").hide();
                if (idEstadoGarantia == '5' || $("#EstadoGarantia option:selected").val() == 5) {
                    $("#trEnvioCierre").show();
                    $('#EnvioCierre').append('<option value= 0 >Seleccione tipo de envío a cierre</option>');
                    $('#EnvioCierre').append('<option value= 1 >No Quiere</option>'); 
                    $('#EnvioCierre').append('<option value= 2 >No Puede</option>');
                    $('#EnvioCierre').append('<option value= 3 >Solucionado Sin Radicación</option>');
                    $('#EnvioCierre').append('<option value= 4 >Solucionado Asume Arreglo</option>');
                    $('#EnvioCierre').append('<option value= 5 >Caso Especial</option>');
                    $('#EnvioCierre').append('<option value= 6 >Zona Común Reportada Por El Cliente</option>');
                    $('#EnvioCierre').append('<option value= 7 >No Aplica Como Garantía</option>'); 
                } else if (idEstadoGarantia == '6' || $("#EstadoGarantia option:selected").val() == 6) {
                    $("#trEnvioCierre").show();
                    $('#EnvioCierre').append('<option value= 8 >5 Llamados</option>');  
                } else{
                    $('#EnvioCierre').append('<option value= 9 >No aplica</option>');
    ...
    function finalizar() {
            ...
            var idcall =  $("#<%= idtransaccion.ClientID %>").val();    
            var idoriginal = document.getElementById("ctl00_MainContent_DatosCliente_TextBox1_textBoxValue").value
            var nombre1 = document.getElementById("ctl00_MainContent_DatosCliente_TextBox2_textBoxValue").value
            var proyecto = document.getElementById("ctl00_MainContent_proyecto_DropDownListValue").value
            var canalradicador = document.getElementById("ctl00_MainContent_canalradicador_DropDownListValue").value
            var numerogarantia = document.getElementById("ctl00_MainContent_DatosCliente_TextBox7_textBoxValue").value
            var proceso = document.getElementById("ctl00_MainContent_proceso_DropDownListValue").value
            var tipestadogarantia = $("#EstadoGarantia option:selected").text();
            var tipenviocierre = $("#EnvioCierre option:selected").text();
            var idfinal = $("#Outbound option:selected").val();
            var desfinal = $("#Outbound option:selected").text();

            if  (tipestadogarantia == '' || $("#EstadoGarantia option:selected").val() == 0) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Seleccione estado de garantia',
                        showConfirmButton: false,
                        timer: 1500
                    });
                    return false;             
                } else if (tipenviocierre == '' || $("#EnvioCierre option:selected").val() == 0) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Seleccione envío a cierre',
                        showConfirmButton: false,
                        timer: 1500
                    });
                    return false;  
                } else if (desfinal == '' || $("#Outbound option:selected").val() == 0) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Seleccione tipifiacion outbound',
                        showConfirmButton: false,
                        timer: 1500
                    });
                    return false;
            ...
            var settings = {
                            ...
                            "data": JSON.stringify({
                                                    ...
                                                    "nombre1": nombre1,
                                                    "apellido1": nombre1,
                                                    "momento": tipestadogarantia,
                                                    "necesidad": tipenviocierre,
                                                    "razon":canalradicador,
                                                    "actividad": desfinal,
                                                    "proyecto" : proyecto,
                                                    "agrupacion": proceso,
                                                    "producto": numerogarantia                                      
                                                      }),
                    };
                    $.ajax(settings).done(function (response) {
                        Swal.fire({
            ...
            valorTelefono = "*10"+ valorTelefono
    ...
    <table class="formulario" style="width:100%;">        
        ...
        <tbody>
                ...
                <td style="padding: 5px; border-style: solid; border-width: 1px; border-color: #ed7203; color: #249e6b ; font-weight: bold; font-size: 14px; width: 201px; vertical-align: middle;" 
                    class="style2">
                    Canal Radicador:<br />
                <evo:DatosCliente_DropDownList ID="canalradicador" runat="server" Clave="CanalRadicador" 
                        EtiquetaAuto="False" ForeColor="Black" LabelStyle-Font-Bold="True" 
                        ValueStyle-Width="85%" Enabled="False">
                        <asp:ListItem Selected="True"></asp:ListItem>
                        <asp:ListItem Value="Bolívar Contigo">Bolívar Contigo</asp:ListItem>
                        <asp:ListItem>ChatBot</asp:ListItem>
                        <asp:ListItem>Correo Electrónico</asp:ListItem>
                        <asp:ListItem Value="Llamada">Llamada</asp:ListItem>
                        <asp:ListItem>Página Web</asp:ListItem>
                        <asp:ListItem>Presencial</asp:ListItem>
                        <asp:ListItem>Funcionario Interno</asp:ListItem>
                        <asp:ListItem>Correspondencia Física</asp:ListItem>
                </evo:DatosCliente_DropDownList> 
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                        ...
                        ErrorMessage="Canal radicador es obligatorio" Font-Size="X-Small"></asp:RequiredFieldValidator>
                </td>
                <td style="padding: 5px; border-style: solid; border-width: 1px; border-color: #ed7203; color: #249e6b ; font-weight: bold; font-size: 14px; width: 201px; vertical-align: middle;" 
                    class="style2">
                    Número de Garantía:<evo:DatosCliente_TextBox 
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                        ...
                        ErrorMessage="Número de garantia es obligatorio" Font-Size="X-Small"></asp:RequiredFieldValidator>
                </td>
                <td style="padding: 5px; border-style: solid; border-width: 1px; border-color: #ed7203; color: #249e6b ; font-weight: bold; font-size: 14px; width: 201px; vertical-align: middle;" 
                    class="style2">
                    Proceso:<evo:DatosCliente_DropDownList ID="proceso" runat="server" Clave="Proceso" 
                        EtiquetaAuto="False" ForeColor="Black" LabelStyle-Font-Bold="True" 
                        ValueStyle-Width="85%" Enabled="False">
                        <asp:ListItem Selected="True"></asp:ListItem>
                        <asp:ListItem Value="Ejecuciones">Ejecuciones</asp:ListItem>
                        <asp:ListItem>Reprogramación</asp:ListItem>
                        <asp:ListItem>Vecinos</asp:ListItem>
                        <asp:ListItem Value="Sin Actividad de Servicio">Sin Actividad de Servicio</asp:ListItem>
                </evo:DatosCliente_DropDownList> 
                ...
                <td style="border: 1px solid #ed7203; padding: 5px; color: #249e6b; font-weight: bold; font-size: 14px; vertical-align: middle; text-align: center;" 
                    ...
                    <input id="Button5" onclick="Llamar()" 
                        ...
                        type="button" value="LLAMAR" onclick="return Button5_onclick()" /></td>
                    </tr>
        </tbody>
    </table>
    <table class="formulario" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                <td class="style4" 
                    ...
                    Estado Garantía:
                    <select id="EstadoGarantia" name="idEstadoGarantia" style="width: 100%" onchange="llenarEnvioCierre(this.value)">
                    <option value= '0' ></option>
                    <option value= '1' >Agendada</option>
                    <option value= '2' >Cancelada</option>
                    <option value= '3' >Pendiente Respuesta PQRs</option>
                    <option value= '4' >Solicitud Duplicada</option>
                    <option value= '5' >Se Envía a Cierre Contactado</option>
                    <option value= '6' >Se Envía a Cierre No Contactado</option>
                    </select></td>
            </tr>
            <tr id="trEnvioCierre">
                <td class="style4" 
                    ...
                    style="border: 1px solid #ed7203; padding: 5px; color: #249e6b; font-weight: bold; font-size: 14px; vertical-align: middle;">
                    Envío a Cierre:
                    <select id="EnvioCierre" name="idEnvioCierre"  style="width: 100%">
            ...
            <tr>
                <td class="style4" 
                    ...
                    style="border: 1px solid #ed7203; padding: 5px; color: #249e6b; font-weight: bold; font-size: 14px; vertical-align: middle;">
                    Tipificación Outbound:
                    <select id="Outbound" name="idOutbound" style="width: 100%">
                        <option value= '0' ></option>
                        <option value= '800' >Contacto Efectivo</option>
                        <option value= '801' >Buzón de Mensajes</option>
                        <option value= '802' >Equivocado</option>
                        <option value= '803' >Fuera de Servicio</option>
                        <option value= '804' >Llamar Luego</option>
                        <option value= '805' >Mensaje Terceros</option>
                        <option value= '806' >No Contesta</option>
                    </select></td>
                </tr>
            <tr>
                <td class="campoti" 
                    ...
                    <input id="Button9" onclick="finalizar()" 
                        style="font-size: 12px; background-color: #249E6B; width: 200px; height: 40px; background-image: none; font-weight: bold; margin-right: 0;" 
                        type="button" value="FINALIZAR" /></td>
            </tr>
        </tbody>
    </table>            
...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim idllamada As String = Gestion.Transaccion.IdTransaccion
        idtransaccion.Value = idllamada
    End Sub
