...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="style1" style="border: 1px solid #2B8B4B">
         <tr>
            <th style="padding: 3px; border: 1px solid #2b8b4b; text-align:center; background-color: #2b8b4b; font-size: 20px; color: #FFFFFF; font-weight: bold;" 
        ...
        <td width="10%" 
                ...
                style="padding: 5px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px; text-align: center;">
                <asp:Button ID="Buscar" runat="server" onclick="Buscar_OnClick" 
                    Text="Buscar" onclientclick="MensajeEspera();" BackColor="#2B8B4B" 
                    BorderColor="#2B8B4B" Height="30px" Width="225px" />
            </td>
            <td width="10%" 
                
                style="padding: 5px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px; text-align: center;">
                <asp:Button ID="Button2" runat="server" onclick="Nuevo_OnClick" 
                    Text="Nuevo" BackColor="#2B8B4B" BorderColor="#2B8B4B" Height="30px" 
    ...
    <asp:GridView ID="GridView1" runat="server" class="formulario" 
        ...
        <AlternatingRowStyle BackColor="White" BorderColor="#2B8B4B" 
...
<ControlStyle Font-Size="16px"></ControlStyle>
        ...
        <EditRowStyle BorderColor="#2B8B4B" BorderStyle="Solid" BorderWidth="1px" />
        <EmptyDataRowStyle BorderColor="#2B8B4B" BorderStyle="Solid" 
            BorderWidth="1px" />
        <EmptyDataTemplate>
