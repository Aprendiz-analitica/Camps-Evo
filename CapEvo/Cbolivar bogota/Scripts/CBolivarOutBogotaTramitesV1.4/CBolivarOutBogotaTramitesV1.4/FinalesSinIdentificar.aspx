...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <script type="text/javascript">
            ...
            function abriragenda() {
                ...
                window.open(
                "https://server05.fenalcovalle.co/CbolivarBgtaAgenda/AsignarCita.jsp?documento=" + document.getElementById("ctl00_MainContent_DatosCliente_TextBox1_textBoxValue").value,
                "vTiger",
                "width=" + width + ",height=" + height + ",top=" + top + ",left=" + left + ",toolbar=0,location=0,directories=0,status=1,menubar=0,scrollbars=1"
                ).focus();
            }
            ...
            <tr>
                ...
                <td style="border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 14px;" 
                    ...
                    <evo:DatosCliente_TextBox ID="DatosCliente_TextBox7" runat="server" EtiquetaAuto="False" 
                        LabelStyle-Font-Bold="True" ValueStyle-ForeColor="Black" 
                        ValueStyle-Width="94%" Clave="Proyecto" />
                </td>
            </tr>
            <tr>
                <td style="border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 14px;" 
                    ...
                    <evo:DatosCliente_TextBox ID="DatosCliente_TextBox9" runat="server" EtiquetaAuto="False" 
                        LabelStyle-Font-Bold="True" ValueStyle-ForeColor="Black" 
                        ValueStyle-Width="94%" Clave="Agrupacion" />
                </td>
                <td style="border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 14px;" 
                    class="style1">
                    &nbsp;</td>
