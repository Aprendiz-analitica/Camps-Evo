...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <thead>
            <tr>
                <th colspan="2" style="text-align:center">
                    Replanificacion [<%= wrapUpCodeDescripcion%>]
                </th>
            </tr>
        </thead>
        <tbody>
		    <tr>
			    ...
			    <td  style="font-weight:bold;text-align:center">
                     <%If calSchedule.SelectedDate.Year > 1 Then%>
                           ...
                           Reprogramar llamada para el dia 
                           </span>
                     ...
                     <%Else
                           ...
                           <span style="font-size:small;  font-weight:bold">
                                Las restricciones de tiempo no permiten programar la rellamada para ninguna hora este dia! 
                           </span>
                     <%End If%>
                </td>
		    </tr>
			    ...
			    <td width="250px" valign="top" >				    
                    <div style = "width: 245px; margin-left:auto; margin-right: auto;">
                        ...
                        <asp:Calendar ID="calSchedule" runat="server" 
                            ...
                            ForeColor="#646D8A" Height="250px" Width="245px" BorderStyle="Solid" 
                            ShowGridLines="True" NextMonthText="&gt;" CssClass="calendar" TabIndex="10" 
                                onselectionchanged="calSchedule_SelectionChanged" OnDayRender="DisabledWeekendsCalendar_DayRender">
                                <DayHeaderStyle BackColor="#2FB5DA" ForeColor="White" Height="15px" BorderColor="#097AA4" BorderStyle="None" HorizontalAlign="Center" />
                                <DayStyle BorderColor="#2FB5DB" BorderStyle="Solid" HorizontalAlign="Center" 
                                    CssClass="calendar" />
                                <NextPrevStyle Font-Size="8pt" ForeColor="White" BackColor="#2FB5DA" Height="15px" />
                                <OtherMonthDayStyle ForeColor="#999999" />
                                <SelectedDayStyle BackColor="#FFE7BB" Font-Bold="True" ForeColor="#646D8A" BorderColor="#2FB5DB" BorderStyle="Solid" Height="10px" />
                                <SelectorStyle BackColor="#99CCCC" ForeColor="#336666" />
                                <TitleStyle BackColor="#2FB5DA" BorderColor="White" BorderWidth="2px" 
                                    Font-Bold="True" Font-Size="10pt" Height="15px" BorderStyle="Solid" 
                ...
                <td valign="top">
				        ...
				        <table width="99%" style="table-layout: fixed;">
                            ...
                            <tr>
				                ...
				                <td style="width: 45px;top: -16px; position: relative;">
                                ...
                                <td>
				                    <div id="scheduleDiv" style="overflow-x:auto; width:100%; height: 101px;">
                        ...
                        <table width="98%" style="margin-left: 6px; background-color: #fdfdfb">
                            ...
                            <tr>
                                ...
                                Puede forzarse un telefono para las siguientes llamadas.<br />

                                <% If EvoAPI.Customer.Locators.Count > 0 Then%>
                                    O dejarse vacio para que el sistema seleccione el siguiente telefono automaticamente.
                                <% End If%>
                                </td>
                            </tr>
					        <tr>
					        ...
					        <tr>
						        <td style="width: 150px;">ultimo tlf. usado:</td>						        
                                <td>
                            ...
                            %>
					        <tr>
                                <td style="width: 150px;">Otros telefonos:</td>
						        <td >
                            ...
                            <tr>
				                <td colspan="2" style="font-weight:bold;text-align:left">
				                    Elija gestor al que realizar la programacion:</td>
				            </tr>
                            <tr>
                                <td colspan="2" style="border-bottom: 1px solid #29AFD5">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                 ...
                 <td height="90">     
                    ...
                    <div id="info">Maximo 255 caracteres</div>
                </td>
            </tr>
            <tr>   
    ...
    <script language="javascript" type="text/javascript">
        ...
        // Fecha de reprogramacion en base a la TZ del cliente
        ...
        function ActualizaInfo(Control, maximoCaracteres) {
            ...
            if (Control.value.length == 0) {
                ...
                info.innerHTML = "¡¡¡ TAMAÑO MaXIMO EXCEDIDO !!!, se truncaran los ultimos " + (Control.value.length - maximoCaracteres) + " caracteres";
            }
        }
        ...
        function ClickCelda(e,fila,col,hora)
        {
            ...
            newCustomerDateTime=new Date(customerDateTime.getFullYear(),customerDateTime.getMonth(),customerDateTime.getDate(),parseInt(hora.substr(0,2)),parseInt(hora.substr(3,2)));
            // Calcular la nueva fecha/hora en terminos de la TZ de sistema
...
<script runat="server">    
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        EvoAPI.Campaign.LoadScheduleConditions()
        ...
        ' Mirar la asignacion del final Volver a llamar
        MirarAsignacion()
        ...
        If Not IsPostBack Then
            ...
            'Establecemos un control por js para su tamaño maximo 255
    ...
    Protected Sub Page_PreRenderComplete(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRenderComplete
        ...
        'Inicializar la fecha/hora de reprogramacion que pasaremos a Javascript
        jscustomerDateTime = String.Format("new Date({0},{1},{2},{3},{4})", calSchedule.SelectedDate.Year, calSchedule.SelectedDate.Month-1, calSchedule.SelectedDate.Day, SelectedTime.Value.Substring(0, 2), SelectedTime.Value.Substring(3, 2))
    ...
    ' Convierte un dia y hora expresados en TZ Cliente a una fecha expresada en la TZ de sistema
    ...
    Protected Function ToSystemTZDateTime(ByVal dia As Date) As Date
       ...
       'Si nos pasan el dia 1/1/1 quiere decir que no han seleccionado fecha. Si restaramos el Shift se produciria excepcion o sea que retornamos Nothing
    ...
    Protected Sub ObtenerAgentesBack()
        ...
        ' Añadimos items siempre presentes
        Item = New ListItem("Asignacion precedente", "-1")
        Item.Selected = True
        DropDownList1.Items.Add(Item)
        Item = New ListItem("GRUPO", "0")
        DropDownList1.Items.Add(Item)
        ...
        Else ' Si no esta definido listamos todos los agentes con permisos sobre esta campaña
        ...
        ' Añadimos items segun resultados de la query
        While dr.Read
    ...
    Protected Sub DisabledWeekendsCalendar_DayRender(sender As Object, e As DayRenderEventArgs)
       ' El calendario es segun la TZ del cliente
        Dim Ahora = ToCustomerTZDateTime(Date.Now)
        Dim DtInicioValidezCust = ToCustomerTZDateTime(DtInicioValidez)
        Dim DtFinalValidezCust = ToCustomerTZDateTime(DtFinalValidez)
        

        If e.Day.Date < Ahora.Date Or e.Day.Date < DtInicioValidezCust Or e.Day.Date > DtFinalValidezCust OrElse Not TestCampaignSchedule(e.Day.Date, Nothing) Then
    ...
    Protected Sub ShowDaySchedule()
        ...
        Dim calculatedTProxContacto As String = " dateadd(ss, " + currentCustomerShift.ToString() + " - isnull(tz.LocalShift,0), TPROXIMOCONTACTO) "

        Dim calScheduleDate = calSchedule.SelectedDate.ToString("dd/MM/yyyy")
        If calSchedule.SelectedDate.Year = 1 Then
            calScheduleDate = "01/01/1901"
        End If

        sql = "SELECT [Asignacion], " + cols_format + " FROM ( "
        sql = sql + "SELECT [Asignacion], " + cols_raw + " FROM (select 'Al Agente' as [Asignacion], REPLICATE( '0', 2-DATALENGTH( CAST( datepart(hour, " + calculatedTProxContacto + ") as varchar) ) ) +  CAST( datepart(hour, " + calculatedTProxContacto + ") as varchar) + ':' + REPLICATE( '0', 2-DATALENGTH(CAST((datepart(MINUTE, " + calculatedTProxContacto + ")/" + gap.ToString() + ")*" + gap.ToString() + " as varchar)) ) + CAST((datepart(MINUTE, " + calculatedTProxContacto + ")/" + gap.ToString() + ")*" + gap.ToString() + " as varchar) as Hora, IDSUJETO from tbIdentidadSujetoCampanya as isc with (nolock) left join TZ_Shift AS tz on isc.IdTimeZoneShift = tz.IdTimeZoneShift where DATEADD(dd, 0, DATEDIFF(dd, 0, " + calculatedTProxContacto + ") ) = CONVERT (datetime, '" + calScheduleDate + "', 103)  and IDAGENTEASIGNADO = " + If(idAgenteAsignado = 0, EvoAPI.Agent.AgentId.ToString(), idAgenteAsignado.ToString()) + " and nEstado=0 and nLista in (" + in_list + ") and idCampanya = " + EvoAPI.Campaign.CampaignId.ToString() + " ) as SourceTable1 PIVOT ( count(IDSUJETO) FOR Hora IN ( " + cols_raw + " ) ) AS PivotTable1"
        sql = sql + " union "
        sql = sql + "SELECT [Asignacion], " + cols_raw + " FROM (select 'Al Grupo' as [Asignacion], REPLICATE( '0', 2-DATALENGTH( CAST( datepart(hour, " + calculatedTProxContacto + ") as varchar) ) ) +  CAST( datepart(hour, " + calculatedTProxContacto + ") as varchar) + ':' + REPLICATE( '0', 2-DATALENGTH(CAST((datepart(MINUTE, " + calculatedTProxContacto + ")/" + gap.ToString() + ")*" + gap.ToString() + " as varchar)) ) + CAST((datepart(MINUTE, " + calculatedTProxContacto + ")/" + gap.ToString() + ")*" + gap.ToString() + " as varchar) as Hora, IDSUJETO from tbIdentidadSujetoCampanya as isc with (nolock) left join TZ_Shift AS tz on isc.IdTimeZoneShift = tz.IdTimeZoneShift where DATEADD(dd, 0, DATEDIFF(dd, 0, " + calculatedTProxContacto + ") ) = CONVERT (datetime, '" + calScheduleDate + "', 103)  and IDAGENTEASIGNADO = 0 and nEstado=0 and nLista in (" + in_list + ") and idCampanya = " + EvoAPI.Campaign.CampaignId.ToString() + " ) as SourceTable2 PIVOT ( count(IDSUJETO) FOR Hora IN ( " + cols_raw + " ) ) AS PivotTable2"
        sql = sql + " ) as temp"
        ...
        'Quitar la columna de asignacion
        ...
        For Each r As GridViewRow In GridView1.Rows
            ...
            For Each c As TableCell In r.Cells
                ...
                ' La hora limite consideramos la que ha dicho el cliente menos 1 minuto (o sea, si dice hasta las 19h no le podemos llamar a las 19h, si a las 18:59)
                b = b And (hora < Integer.Parse(HHasta.Left(2)) Or (Integer.Parse(HHasta.Left(2)) = hora And mi < Integer.Parse(HHasta.Substring(3))))

                ' Si han seleccionado el dia de hoy...
                If calSchedule.SelectedDate = Ahora.Date Then
                    ' Deshabilitar las horas del dia que ya han transcurrido
                ...
                If b Then
                    ...
                    If iSelected < 0 Then
                        ...
                        'Inicializar la hora de seleccion
        ...
        Else
            'No hay ninguna hora seleccionable en el dia de hoy, deseleccionar fecha
    ...
    Protected Sub ValidateInput()
        ...
        If wrapUpCode Is Nothing Then
            Message.ShowError("El final aplicado a la gestion no existe en la campaña activa.")

        ElseIf wrapUpCode.CallDispositionClass <> 3 Then
            Message.ShowError("El final aplicado a la gestion no admite replanificacion de llamadas.")
    ...
    Protected Sub DateCustVal_Validate(ByVal source As Object, ByVal args As ServerValidateEventArgs)
        ...
        If calSchedule.SelectedDate.Date < Ahora.Date Then
            valCalendar.ErrorMessage = "No puede seleccionar una fecha anterior al dia en curso"
    ...
    Protected Sub TimeCustVal_Validate(ByVal source As Object, ByVal args As ServerValidateEventArgs)
        ...
        If String.IsNullOrEmpty(sHora) Or String.IsNullOrEmpty(sMin) Then
            args.IsValid = False
            valTime.ErrorMessage = "No se ha seleccionado un dia/hora para programar la llamada."
    ...
    Protected Sub PhoneCustVal_Validate(ByVal source As Object, ByVal args As ServerValidateEventArgs)
        If String.IsNullOrWhiteSpace(tbxPhone.Text) Then
            If EvoAPI.Customer.Locators.Count = 0 Then
                valPhone.ErrorMessage = "El telefono forzado no puede estar en blanco"
        ...
        If Not regex.IsMatch(tbxPhone.Text) Then
            valPhone.ErrorMessage = "Formato incorrecto del telefono" + IIf(String.IsNullOrWhiteSpace(Request("sMascara")), "", ". Mascara: " + Request("sMascara"))
    ...
    Protected Sub btnCloseTransaction_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If bEnableScheduleButton AndAlso valCalendar.IsValid AndAlso valPhone.IsValid AndAlso valTime.IsValid Then
            ...
            EvoAPI.DispositionCall(idWrapUpCode, dtSchedule, interval, share)
        End If
    End Sub
    ...
    Protected Function TestCampaignSchedule(ByVal dia As Date, ByVal hora As Date?) As Boolean
        ...
        If IsNothing(hora) Then
            b = EvoAPI.Campaign.IsCampaignOn(dia, Nothing)
        Else
            ' Caso especial: si la hora a testar es EXCTAMENTE IGUAL al limite de hora superior
            ' la campaña estaria activa...un segundo. Como estoy evaluando para permitir o no reprogramaciones 
            ' voy a testar siempre la hora que me pasan... mas un segundo. 
            b = EvoAPI.Campaign.IsCampaignOn(dia, hora.Value.AddSeconds(1))
        End If
    ...
    Protected Sub AgenteAsignadoSeleccionado(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        'Refrescamos la programacion segun la seleccion de asignacion de agente realizada
        ShowDaySchedule()

    End Sub

    Protected Sub ActualizaAgenteAsignado()
        'Solo si ha elegido en el desplegable algo distinto a "Asignacion precedente"
        If (DropDownList1.SelectedValue <> -1) Then
    ...
    Protected Sub Guardar_Observacion(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not String.IsNullOrEmpty(DatosCliente_Observations.TextValue) Then
            ' Salvamos la ultima observacion recogida           
            EvoAPI.Customer.Remarks = DatosCliente_Observations.TextValue
            EvoAPI.Customer.Save()

            Traces.Debug("Transaccion: " + EvoAPI.Transaction.TransactionId.ToString + " Rellamadas --> INI Guardar Observacion")
            ...
            SqlDataSource1.Update()
            Traces.Debug("Transaccion: " + EvoAPI.Transaction.TransactionId.ToString + " Rellamadas --> FIN Guardar Observacion")
        End If
