        ...
        <tbody>
            ...
            <td style="border: 1px solid #ed7203; padding: 5px; color: #249e6b; font-weight: bold; font-size: 14px; vertical-align: middle; text-align: center;" 
                    ...
                    <asp:DropDownList ID="DropDownList2" runat="server" 
                        Width="100%" Visible="False">
                         <asp:ListItem></asp:ListItem>
                        <asp:ListItem Value="1">PGP</asp:ListItem>
                        <asp:ListItem Value="2">EVENTO</asp:ListItem>
                    </asp:DropDownList>
                    <br />
...
<script runat="server">
    ...
    Protected Sub Asignacion_Cita(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ' Obtener el texto del ítem seleccionado en DropDownList2
        Dim convenio As String = If(DropDownList2.SelectedItem.Text = "", Nothing, DropDownList2.SelectedItem.Text)

        ' Realiza la gestión final con el valor seleccionado
        If Not String.IsNullOrEmpty(selectedEpsId) Then
            Response.Redirect("~/InsertarEps.aspx?epsC=" + selectedEpsId + "&FinalGestion=" + selectedValue + "&tipoConvenio=" + convenio)
        Else
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ' Obtener el texto del ítem seleccionado en DropDownList1
        Dim eps As String = DropDownList1.SelectedItem.Text.Trim()
        
        DropDownList2.SelectedIndex = 0
        
        If eps = "SOS" OrElse eps = "EMSSANAR" Then
