...
var agentapi = new function () {
    ...
    function webServiceActionURL(action, params) {
        ...
        /// <param name="params" type="String">Parametros en formato querystring de la peticion.</param>
        /// <returns type="String">URL para la peticion.</returns>
    ...
    function executeAgentapiAction(iAgentCallBack, webAgentCallBack) {
        /// <summary>Ejecuta el callback correspondiente a iAgent o WebAgent segun corresonda</summary>
        /// <param name="sURL" type="String">Accion</param>
        /// <param name="sURL" type="String">Parametros en formato querystring de la peticion.</param>
        /// <returns type="iagent.agentscript">ActiveXObject("iagent.agentscript")</returns>
    ...
    this.FastTransferActiveCall = function (telNumber) {
        ...
        /// <param name="telNumber" type="Number">Numero al que redirigir.</param>
        /// <returns type="Deferred"></returns>
...
var agentapi_105 = new function () {
    ...
    this.IdentificadoSujetoInterloc = function (idSujeto, idTransaccion) {
        /// <summary>Identifica un sujeto en una transaccion.</summary>
    ...
    this.RealizarLlamada = function (sNumTel) {
        ...
        /// <param name="sNumTel" type="Number">Numero de telefono a llamar.</param>
        /// <returns type="Deferred"></returns>
        return agentapi.MakeCall(sNumTel);
    }

    this.RealizarLlamadaEnCampanya = function (idTransaction) {
        /// <summary>Realiza una llamada vinculada a la transaccion al telefono correspondiente al registro actual.</summary>
        /// <param name="idTransaction" type="Number">Transaccion de la gestion.</param>
        /// <returns type="Deferred"></returns>
        return agentapi.MakeCampaignCall(idTransaction);
    }

    this.RealizarLlamadaEnCampanyaEx = function (idTransaction, sNumTel) {
        /// <summary>Realiza una llamada vinculada a la transaccion al telefono indicado.</summary>
        /// <param name="idTransaction" type="Number">Transaccion de la gestion.</param>
        /// <param name="sNumTel" type="Number">Numero de telefono a llamar.</param>
        /// <returns type="Deferred"></returns>
    ...
    this.TransferirLlamadaActiva = function (sNumTel) {
        /// <summary>Transfiere la llamada activa al numero indicado.</summary>
        /// <param name="sNumTel" type="Number">Numero de telefono receptor de la transferencia.</param>
        /// <returns type="Deferred"></returns>
        return agentapi.TransferActiveCall(sNumTel);
    }

    this.AparcarYTransferirLlamadaActiva = function (sNumTel) {
        /// <summary>Transfiere la llamada activa al numero indicado, aparcando la llamada previemente.</summary>
        /// <param name="sNumTel" type="Number">Numero de telefono receptor de la transferencia.</param>
        /// <returns type="Deferred"></returns>
    ...
    this.ObtenerLlamadasActuales = function () {
        /// <summary>Obtiene el numero de llamadas en curso.</summary>
        /// <returns type="Deferred"></returns>
    ...
    this.ObtenerIdLlamada = function (index) {
        /// <summary>Obtiene el identificador de la llamada correspondiente a la posicion indicada por index.</summary>
        /// <param name="index" type="Number">Posicion de la llamada.</param>
        /// <returns type="Deferred"></returns>
        return agentapi.GetCallId(index);
    }

    this.ObtenerEstadoLlamada = function (index) {
        /// <summary>Obtiene el estado de la llamada correspondiente a la posicion indicada por index.</summary>
        /// <param name="index" type="Number">Posicion de la llamada.</param>
        /// <returns type="Deferred"></returns>
    ...
    this.ConferenciarLlamadaActiva = function (sNumTel) {
        /// <summary>Ponse la llamada en conferencia con la llamada activa y el numero indicado.</summary>
        /// <param name="sNumTel" type="Number">Numero de telefono con el cual realizar la conferencia.</param>
        /// <returns type="Deferred"></returns>
        return agentapi.ConferenceActiveCall(sNumTel);
    }

    this.IniciarGrabacion = function () {
        /// <summary>Inicia la grabacion de la llamada.</summary>
        /// <returns type="Deferred"></returns>
        return agentapi.StartRecording();
    }

    this.FinalizarGrabacion = function () {
        /// <summary>Finaliza la grabacion de la llamada.</summary>
        /// <returns type="Deferred"></returns>
        return agentapi.StopRecording();
    }

    this.MarcarGrabacion = function (index, texto) {
        /// <summary>Marcar la grabacion de la llamada.</summary>
        /// <param name="index" type="Number">Posicion de la marca.</param>
    ...
    this.SendDTMF = function (idCall, digits) {
        /// <summary>Envia DTMF a la llamada correspondiente.</summary>
        /// <param name="idCall" type="Number">Id de la llamada a enviar DTMF.</param>
        /// <param name="digits" type="Number">Digitos a enviar por DTMF.</param>
        /// <returns type="Deferred"></returns>
    ...
    this.RedirigirLlamadaActiva = function (sNumtel) {
        /// <summary>Redirige la llamada activa al numero de telefno indicado.</summary>
        /// <param name="sNumtel" type="Number">Numero al que redirigir</param>
        /// <returns type="Deferred"></returns>
