        ...
        <div style="position: initial; overflow: hidden;" > 
            <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #2b8b4b;">
                <div class="container-fluid">
                    ...
                    <a href="Manager.jsp" class="navbar-brand">Salir</a
                </div>        
            </nav>
        ...
        <table id="dataTable" class="table table-striped table-bordered" style="color: #f8db66">
            ...
            <tbody>
                <%                    try {
                        ...
                        String sql1 = "";
                        sql1 = "Select A.idTransaccion,A.tFinal,A.idFinal,CONCAT(B.sNombreUsuario,' ',B.sApellido1Usuario) as Agente,C.sOrigen from tbHistoFTransacciones A INNER JOIN tbHistoDAgentes B  ON A.idAgente = B.idAgente INNER JOIN tbHistoFContactos C ON A.idTransaccion = C.idTransaccion where A.idFinal = 302 and A.idCampanya in (100000268,100000274,100000431,100000362,100000492,100000365,100000364,100000363) and C.idAgente !=0 and C.nSentido = 1 and A.tCreacion  between '" + fechaIn + "T00:00:00' AND '" + fechaFin + "T23:59:59' UNION(Select A.idTransaccion,A.tFinal,A.idFinal,CONCAT(B.sNombreUsuario,' ',B.sApellido1Usuario) as Agente,C.sOrigen from TRANSACCION A INNER JOIN tbHistoDAgentes B  ON A.idAgente = B.idAgente INNER JOIN tbContactos C ON A.idTransaccion = C.idTransaccion where A.idFinal = 302 and A.idCampanya in (100000268,100000274,100000431,100000362,100000492,100000365,100000364,100000363) and C.idAgente !=0 and C.nSentido = 1 and A.tCreacion  between '" + fechaIn + "T00:00:00' AND '" + fechaFin + "T23:59:59')";PreparedStatement ps1 = con1.prepareStatement(sql1);
