...
<html>
    <head>
        ...
        <%
            ...
            String desfinal = "100000526"; //request.getParameter("desfinal");
        %>
                ...
                <%
                    try {
                        ...
                        String sql1 = "SELECT c.IDORIGINAL, "
                                + "PivotTable.NOMBREGESTION, "
                                + "c.TELEFONO, "
                                + "PivotTable.FECHACREACION, "
                                + "PivotTable.ESTADOFINAL, "
                                + "PivotTable.ORIGEN, "
                                + "c.NOMBRE AS EMPRESACLIENTE, "
                                + "c.OBSERVACIONES, "
                                + "(SELECT DESCRIPCION FROM FINALES f WHERE f.idFinal = t.idFinal AND idCampanya = t.idCampanya) AS DESCRIPCION, "
                                + "t.tFinal AS TFINAL, "
                                + "CONCAT(age.sNombreUsuario, ' ', age.sApellido1Usuario) AS AGENTE "
                                + "FROM ( "
                                + "SELECT clave, idSujeto, valor FROM tbDatosCliente "
                                + ") AS SourceTable "
                                + "PIVOT ( "
                                ...
                                + "FROM TRANSACCION vt "
                                + "WHERE "
                                + "vt.tCreacion BETWEEN '" + fechaIn + "T00:00:00' AND '" + fechaFin + "T23:59:59' "
                                + "AND vt.idCampanya = " + desfinal
