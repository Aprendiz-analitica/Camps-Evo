...
<html>
        ...
        <script>
            ...
            function actualizar() {
                ...
                switch (idfinal) {
                        ...
                        break;
                        case "1614":
                        desfinal = "EXÁMEN DE CARDIOLOGÍA";
                        break;
                        case "1615":
                        desfinal = "ELECTROCARDIOGRAMA";
                        break;
                        case "1616":
                        desfinal = "ECO TT";
                        break;
                        case "1617":
                        desfinal = "ECO ESTRESS";
                        break;
                        case "1618":
                        desfinal = "UNIDAD DIGESTIVA";
                        break;
                        case "1619":
                        desfinal = "RAYOS X";
                        break;
                        case "1620":
                        desfinal = "CONSULTA PARTICULAR";
                        break;
                        case "1621":
                        desfinal = "OTROS";
                        break;
    ...
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        ...
          <label for="1612">TOMOGRAFÍA</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
...
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px">                     
    ...
      <label for="1614">EXÁMEN DE CARDIOLOGÍA</label><br> 
</td>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
    <input type="radio" id="1615" name="Cotizacion" value="1615">
      <label for="1615">ELECTROCARDIOGRAMA</label><br>
</td>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
    <input type="radio" id="1616" name="Cotizacion" value="1616">
      <label for="1616">ECO TT</label><br>
</td>
...
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px">                     
    ...
      <label for="1617">ECO ESTRESS</label><br> 
</td>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
    <input type="radio" id="1618" name="Cotizacion" value="1618">
      <label for="1618">UNIDAD DIGESTIVA</label><br>
</td>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
    <input type="radio" id="1619" name="Cotizacion" value="1619">
      <label for="1619">RAYOS X</label><br>
</td>
