...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=SinDisponibilidadSanitasPGP]:checked').val()
        ...
        <tr>
            ...
            FINALES SIN DISPONIBILIDAD SANITASPGP</th>
        </tr>
    </thead>
    <tbody>
        <%
    ...
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px">                     
        <input type="radio" id="0" name="SinDisponibilidadSanitasPGP" value="0" hidden = "true" checked >  
        <input type="radio" id="2200" name="SinDisponibilidadSanitasPGP" value="2200">
          <label for="2200">ELECTROFISIOLOGIA</label><br>
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="2201" name="SinDisponibilidadSanitasPGP" value="2201">
          <label for="2201">REPROGRAMACION DE MARCAPASOS</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="2202" name="SinDisponibilidadSanitasPGP" value="2202">
          <label for="2202">CIRUGIA VASCULAR</label>     
    </td>
</tr>
<tr>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px">                     
    <input type="radio" id="2203" name="SinDisponibilidadSanitasPGP" value="2203">
      <label for="2203">CIRUGIA CARDIOVASCULAR</label><br> 
</td>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
