...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=ConfirmacionDeCitaSanitasPGP]:checked').val()
                ...
                switch (idfinal) {
                        case "2000":
                        desfinal = "ELECTROFISIOLOGIA";
                        break;
                        case "2001":
                        desfinal = "REPROGRAMACION DE MARCAPASOS";
                        break;
                        case "2002":
                        desfinal = "CIRUGIA VASCULAR";
                        break;
                        case "2003":
                        desfinal = "CIRUGIA CARDIOVASCULAR";
                        break;
        ...
        <tr>
            <th colspan="4" style="font-weight: bold; font-family: 'Roboto', sans-serif; color: white; background-color: #00854fe6;font-size: 13px; border : 1px solid #00854fe6; width: 100% ;height: 50px">
                FINALES CONFIRMACION DE CITA SANITASPGP</th>
        </tr>
    </thead>
    <tbody>
        <%
    ...
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px">                     
        <input type="radio" id="0" name="ConfirmacionDeCitaSanitasPGP" value="0" hidden = "true" checked >  
        <input type="radio" id="2000" name="ConfirmacionDeCitaSanitasPGP" value="2000">
          <label for="2000">ELECTROFISIOLOGIA</label><br>
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="2001" name="ConfirmacionDeCitaSanitasPGP" value="2001">
          <label for="2001">REPROGRAMACION DE MARCAPASOS</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="2002" name="ConfirmacionDeCitaSanitasPGP" value="2002">
          <label for="2002">CIRUGIA VASCULAR</label>     
    </td>
</tr>
<tr>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px">                     
    <input type="radio" id="2003" name="ConfirmacionDeCitaSanitasPGP" value="2003">
      <label for="2003">CIRUGIA CARDIOVASCULAR</label><br> 
</td>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
