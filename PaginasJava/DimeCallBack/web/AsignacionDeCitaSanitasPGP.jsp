...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=AsignacionDeCitaSanitasPGP]:checked').val()
        ...
        <tr>
            <th colspan="4" style="font-weight: bold; font-family: 'Roboto', sans-serif; color: white; background-color: #00854fe6;font-size: 13px; border : 1px solid #00854fe6; width: 100% ;height: 50px">
                FINALES ASIGNACION DE CITA SANITASPGP</th>
        </tr>
    </thead>
    <tbody>
        <%
    ...
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px">                     
        <input type="radio" id="0" name="AsignacionDeCitaSanitasPGP" value="0" hidden = "true" checked >  
        <input type="radio" id="1900" name="AsignacionDeCitaSanitasPGP" value="1900">
          <label for="1900">ELECTROFISIOLOGIA</label><br>
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="1901" name="AsignacionDeCitaSanitasPGP" value="1901">
          <label for="1901">REPROGRAMACION DE MARCAPASOS</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="1902" name="AsignacionDeCitaSanitasPGP" value="1902">
          <label for="1902">CIRUGIA VASCULAR</label>     
    </td>
</tr>
<tr>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px">                     
    <input type="radio" id="1903" name="AsignacionDeCitaSanitasPGP" value="1903">
      <label for="1903">CIRUGIA CARDIOVASCULAR</label><br> 
</td>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
