...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=SinDisponibilidadAgenda]:checked').val()
                ...
                switch (idfinal) {
                    case "1300":
                        desfinal = "SD DIAGN POLIZAS";
                        break;
                    case "1301":
                        desfinal = "SD DIAGN PARTICULAR";
                        break;
                    case "1302":
                        desfinal = "SD DIAGN EPS SANITAS";
                        break;
                    case "1303":
                        desfinal = "SD DIAGN EPS SURA";
                        break;
                    case "1304":
                        desfinal = "SD DIAGN OTRAS EPS";
                        break;
                    case "1305":
                        desfinal = "SD DIAGN OTRAS EPS";
                        break;
        ...
        <tr>
            <th colspan="3" style="font-weight: bold; font-family: 'Roboto', sans-serif; color: white; background-color: #00854fe6;font-size: 13px; border : 1px solid #00854fe6; width: 100% ;height: 50px">
                 FINALES SIN DISPONIBILIDAD AGENDA</th>
        </tr>
    </thead>
    <tbody>
        <%
    ...
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">                    
        <input type="radio" id="0" name="SinDisponibilidadAgenda" value="0" hidden = "true" checked >  
        <input type="radio" id="1300" name="SinDisponibilidadAgenda" value="1300">
          <label for="1300">SD DIAGN POLIZAS</label><br>
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;"> 
        <input type="radio" id="1301" name="SinDisponibilidadAgenda" value="1301">
          <label for="1301">SD DIAGN PARTICULAR</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;"> 
        <input type="radio" id="1302" name="SinDisponibilidadAgenda" value="1302">
          <label for="1302">SD DIAGN EPS SANITAS</label>     
    </td>

</tr>
<tr>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">                    
        <input type="radio" id="1303" name="SinDisponibilidadAgenda" value="1303">
          <label for="1303">SD DIAGN EPS SURA</label><br>
    </td>

    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;"> 
        <input type="radio" id="1304" name="SinDisponibilidadAgenda" value="1304"
                 <label for="1304">SD DIAGN OTRAS EPS</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;"> 
        <input type="radio" id="1305" name="SinDisponibilidadAgenda" value="1305"
                 <label for="1305">SD DIAGN PAC</label><br> 
    </td>
...
<tr>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;"> 
        <input type="radio" id="1306" name="SinDisponibilidadAgenda" value="1306"
                 <label for="1306">SD DIAGN MP</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">  
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">  
