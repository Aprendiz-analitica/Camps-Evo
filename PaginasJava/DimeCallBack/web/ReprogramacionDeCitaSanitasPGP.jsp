...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=ReprogramacionDeCitaSanitasPGP]:checked').val()
        ...
        <tr>
            <th colspan="4" style="font-weight: bold; font-family: 'Roboto', sans-serif; color: white; background-color: #00854fe6;font-size: 16px; border : 1px solid #00854fe6; width: 100% ;height: 50px">
                FINALES REPROGRAMACION DE CITA SANITASPGP</th>
        </tr>
    </thead>
    <tbody>
        <%
    ...
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px">                     
        <input type="radio" id="0" name="ReprogramacionDeCitaSanitasPGP" value="0" hidden = "true" checked >  
        <input type="radio" id="3000" name="ReprogramacionDeCitaSanitasPGP" value="3000">
          <label for="3000">ELECTROFISIOLOGIA</label><br>
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="3001" name="ReprogramacionDeCitaSanitasPGP" value="3001">
          <label for="3001">REPROGRAMACION DE MARCAPASOS</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="3002" name="ReprogramacionDeCitaSanitasPGP" value="3002">
          <label for="3002">CIRUGIA VASCULAR</label>     
    </td>
</tr>
<tr>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px">                     
    <input type="radio" id="3003" name="ReprogramacionDeCitaSanitasPGP" value="3003">
      <label for="3003">CIRUGIA CARDIOVASCULAR</label><br> 
</td>
<td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
