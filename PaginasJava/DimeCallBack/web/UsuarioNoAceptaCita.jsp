...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=UsuarioNoAceptaCita]:checked').val()
                ...
                switch (idfinal) {
                    case "1700":
                        desfinal = "NO ACEPTA CITA CONSULTA EXTERN";
                        break;
                    case "1701":
                        desfinal = "NO ACEPTA CITA  CARDIOLOGIA";
                        break;
                    case "1702":
                        desfinal = "NO ACEPTA CITA DIAGNOSTICO";
                        break;
                    case "1703":
                        desfinal = "NO ACEPTA CITA PDTO CARDIOLOGI";
                        break;
                    case "1704":
                    ...
                    case "1705":
                        ...
                        break;
                    case "1706":
                        desfinal = "NO ACEPTA CITA PDTO NEUMOLOGIA";
                        break;
        ...
        <tr>
            <th colspan="3" style="font-weight: bold; font-family: 'Roboto', sans-serif; color: white; background-color: #00854fe6;font-size: 13px; border : 1px solid #00854fe6; width: 100% ;height: 50px">
                FINALES USUARIO NO ACEPTA CITA</th>
        </tr>
    </thead>
    <tbody>
        <%
    ...
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">                    
        <input type="radio" id="0" name="UsuarioNoAceptaCita" value="0" hidden = "true" checked >  
        <input type="radio" id="1700" name="UsuarioNoAceptaCita" value="1700">
          <label for="1700">NO ACEPTA CITA CONSULTA EXTERN</label><br>
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="1701" name="UsuarioNoAceptaCita" value="1701">
          <label for="1701">NO ACEPTA CITA  CARDIOLOGIA</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="1702" name="UsuarioNoAceptaCita" value="1702">
...
<tr>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">                     
        <input type="radio" id="1703" name="UsuarioNoAceptaCita" value="1703">
          <label for="1703">NO ACEPTA CITA PDTO CARDIOLOGI</label><br>
    </td>


    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="1704" name="UsuarioNoAceptaCita" value="1704">
          <label for="1704">NO ACEPTA CITA UNIDAD DIGESTIV</label><br> 
    </td>


    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="1705" name="UsuarioNoAceptaCita" value="1705">
          <label for="1705">NO ACEPTA CITA CONSULTA CIRUGI</label><br> 
    </td>
...
<tr>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
        <input type="radio" id="1706" name="UsuarioNoAceptaCita" value="1706">
          <label for="1706">NO ACEPTA CITA PDTO NEUMOLOGIA</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
    </td>
    <td style="text-align: left; font-weight: bold; font-family: 'Roboto', sans-serif; color: grey; border : 1px solid #00854fe6; height: 50px; width: 255.66px; font-size: 11px;">
