...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <tr>
            <th colspan="1" style="font-weight: bold; font-family: Lato; color: white; background-color: #00b85d;font-size: 16px; border : 1px solid #00b85d; width: 100% ;height: 50px">
                FINALES INFORMACIÓN GENERAL</th>
        </tr>
    </thead>
    <tbody>
        <%
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #00b85d; height: 50px; font-size: small">                     
        <input type="radio" id="0" name="FSTC" value="0" hidden = "true" checked >  
        <input type="radio" id="2300" name="FSTC" value="2300">
          <label for="2300">DIRECCIONAMIENTO DE CORREO</label><br>
    </td>
