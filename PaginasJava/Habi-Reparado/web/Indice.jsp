            ...
            <tbody>
                <%
                    try {
                        ...
                        String sql1 = "SELECT c.IDORIGINAL, c.NOMBRE, c.TELEFONO,c.APELLIDO1, c.OBSERVACIONES, "
                                ...
                                + "FROM "
                                + "(SELECT clave, idSujeto, valor FROM tbDatosCliente) AS SourceTable "
                                + "PIVOT "
                                + "( "
                                + "    MAX(valor) "
                                + "    FOR clave IN ( "
                                ...
                                + ") AS PivotTable "
                                + "INNER JOIN "
                                + "tbHistoFTransacciones t ON PivotTable.idSujeto = t.idSujeto "
                                + "INNER JOIN "
                                + "CLIENTES c ON c.IDSUJETO = t.idSujeto "
                                + "INNER JOIN "
                                + "tbHistoDAgentes age ON t.idAgente = age.idAgente "
                                + "WHERE "
                                + "t.idTransaccion IN ( "
