...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=Audifonos]:checked').val()
                ...
                switch (idfinal) {
                    ...
                    case "900":
                        ...
                        break;
                    case "901":
                        desfinal = "CONTROL AUDIFONOS";
                        break;
                    case "902":
                        desfinal = "MOLDE";
                        break;
                    case "903":
                        desfinal = "ADAPTACION DE AUDIFONOS NO VEN";
                        break;
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="Audifonos" value="0" hidden = "true" checked > 
        <input type="radio" id="900" name="Audifonos" value="900">
          <label for="500">COTIZACION</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="901" name="Audifonos" value="901">
          <label for="501">CONTROL DE AUDIFONOS</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="902" name="Audifonos" value="902">
          <label for="502">MOLDE</label>     
    </td>

</tr>
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="903" name="Audifonos" value="903">
          <label for="503">ADAPTACION DE AUDIFONOS NO VEN</label>     
<tr>
