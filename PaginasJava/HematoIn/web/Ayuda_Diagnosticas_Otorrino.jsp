...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=Ayuda_Diagnosticas_Otorrino]:checked').val()
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES - AYUDA DIAGNOSTICAS OTORRINO</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="Ayuda_Diagnosticas_Otorrino" value="0" hidden = "true" checked > 
        <input type="radio" id="1100" name="Ayuda_Diagnosticas_Otorrino" value="1100">
          <label for="1100">ESTROBOSCOPIA</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="1101" name="Ayuda_Diagnosticas_Otorrino" value="1101">
          <label for="1101">VHIT</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="1102" name="Ayuda_Diagnosticas_Otorrino" value="1102">
          <label for="1102">ENG</label>     
    </td>

</tr>
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="1103" name="Ayuda_Diagnosticas_Otorrino" value="1103">
          <label for="1103">PEA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="1104" name="Ayuda_Diagnosticas_Otorrino" value="1104">
          <label for="1104">NASOLARINGOSCOPIA</label>     
    </td>

    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="1105" name="Ayuda_Diagnosticas_Otorrino" value="1105">
          <label for="1105">ELECTROCOCLEOGRAFIA</label>     
    </td>
<tr>
