...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=FAC]:checked').val()
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;">                     
        <input type="radio" id="0" name="FAC" value="0" hidden = "true" checked >  
        <input type="radio" id="100" name="FAC" value="100">
          <label for="100">CONVENIOS</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;">
        <input type="radio" id="101" name="FAC" value="101">
          <label for="101">CAJA SIN FRONTERAS</label><br> 
    </td>
...
<tr>
    <td colspan="3" style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;  padding: 10px">
