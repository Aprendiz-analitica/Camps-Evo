...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <tr>
            <th colspan="2" style="font-weight: bold; font-family: Lato; color: white; background-color: #ED7203;font-size: 16px; border : 1px solid #ED7203; width: 100% ;height: 50px">
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;">                     
        ...
        <input type="radio" id="164" name="FSTC" value="164">
          <label for="164">Subsidio de vivienda</label><br>
    </td>


    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;;">
        <input type="radio" id="166" name="FSTC" value="166">
          <label for="166">Proyectos de Vivienda</label>     
    </td>
