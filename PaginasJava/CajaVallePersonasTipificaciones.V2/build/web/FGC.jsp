        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FCC2]:checked').val()
                    ...
                    switch(idfinal){
                        case "185":
                            desfinal = "Consulta Empresarial";
                        break;
                        case "186":
                            desfinal = "Afiliación patronal";
                        break;
                        case "187":
                            desfinal = "Venta Empresarial";
                        break;
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;">                     
                    <input type="radio" id="0" name="FCC2" value="0" hidden = "true" checked >  
                    <input type="radio" id="185" name="FCC2" value="185">
                      <label for="185">CUNSULTA EMPRESARIAL</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;">
                      <input type="radio" id="186" name="FCC2" value="186">
                      <label for="186">AFILIACIÓN PATRONAL</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;">
                      <input type="radio" id="187" name="FCC2" value="187">
                      <label for="187">VENTA EMPRESARIAL</label>     
                </td>
