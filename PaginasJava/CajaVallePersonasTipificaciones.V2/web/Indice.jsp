...
<html>
    <head>
        ...
        <%
            ...
            String titulo;
            String codigoagente = request.getParameter("codigoagente");
            if (codigoagente != "") {
    ...
    <div class="modal" id="ModalFinales" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" keyboard="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" >
                <div class="modal-body" id ="contenido" style="    display: flex; flex-direction: column; align-items: center;">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" >
                ...
                <div class="modal-footer">
                    <button type="button"  data-dismiss="modal" class="btn btn-secondary" style="background-color: #24a26f;color: white;border-color: #24a26f;">Atras</button>
                </div>
            </div>
        </div>
    </div> 
