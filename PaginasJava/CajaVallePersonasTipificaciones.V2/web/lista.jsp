...
<html>
    <head>
        <meta http-equiv=Llamadas"Content-Type" content="text/html; charset=UTF-8">
        <title>Caja comfe valle Llamadas sin tipificar</title>
    ...
    <body>
        <div id="wrapper">
            <form name="fmrCampana" action="Manajer.jsp" class="login-form" method="post">
                <div class="form-group">
                    <div class="header" style="text-align: center;">
                        <img style="position:relative;" src="img/Asertis.png" alt="Asertis" width="200px" >
                        <label for="exampleFormControlSelect1" style="color: #212120e6 ">LLAMADAS SIN TIPIFICAR</label>
                    </div>
                ...
                <div class="footer" style="text-align: center;">
                    <button  type="submit" class="button"  
                             style="background-color: #00854f;color: white;border-color: #415b75; width:120px; height:38px;" 
