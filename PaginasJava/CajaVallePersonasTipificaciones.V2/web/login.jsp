...
<html>
    ...
    <body>
        ...
        <%  try {
                ...
                if (rs.next()) {
                    // Las credenciales son válidas, redirigir al usuario a la página de bienvenida
                    ...
                    // Insertar un registro en la base de datos con la hora de inicio y final de sesión
                    PreparedStatement insertStmt = conn.prepareStatement("INSERT INTO SesionesComfeWebChat (usuario, inicio_sesion) VALUES (?, ?)");
                    insertStmt.setString(1, username);
                    insertStmt.setString(2, fechaHora);
                    //insertStmt.setString(3, fechaHora);
                    ...
                    if (tipousuario == 1 || tipousuario == 5) {
                        ...
                        response.sendRedirect("Indice.jsp?codigoagente="+idusuario);
                    }
                } else {
