...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                ...
                switch (idfinal) {
                    ...
                    case "140":
                        desfinal = "Info líneas de crédito";
                                break;

                    case "157":
                        desfinal = "Anticipo de subsidio";
                        break;

                    case "159":
                        desfinal = "Solicitud Estado de cartera";
                        break;
        ...
        <tr>
            <th colspan="3" style="font-weight: bold; font-family: Lato; color: white; background-color: #ED7203;font-size: 16px; border : 1px solid #ED7203; width: 100% ;height: 50px">
                FINALES CONFIRMACIÓN DE CITA</th>
        </tr>
    </thead>
    <tbody>
        <%
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;">                     
        ...
        <input type="radio" id="140" name="FSTC" value="140">

          <label for="140">Info líneas de crédito</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;;">
        <input type="radio" id="157" name="FSTC" value="157">
          <label for="157">Anticipo de subsidio</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;;">
        <input type="radio" id="159" name="FSTC" value="159">
          <label for="159">Solicitud Estado de cartera</label>     
    </td>
</tr>
