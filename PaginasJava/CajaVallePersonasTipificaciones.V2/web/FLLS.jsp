        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FUNAC]:checked').val()
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ED7203; height: 50px; font-size: small;">                     
                    <input type="radio" id="0" name="FUNAC" value="0" hidden = "true" checked >  
                    <input type="radio" id="170" name="FUNAC" value="170">
                      <label for="170">Gestion Outbound</label><br>
                </td>
