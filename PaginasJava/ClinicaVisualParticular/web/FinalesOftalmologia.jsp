...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=FinalesOftalmologia]:checked').val()
                ...
                switch (idfinal) {
                    case "100":
                        desfinal = "PRIMERA VEZ OFTALMOLOGIA";
                        break;
                    case "101":
                        desfinal = "CONTROL OFTALMOLOGIA";
                        break;
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES OFTALMOLOGÍA</th>
        </tr>
    </thead>
    <tbody>
        <%
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="FinalesOftalmologia" value="0" hidden = "true" checked >  
        <input type="radio" id="100" name="FinalesOftalmologia" value="100">
          <label for="100">PRIMERA VEZ OFTALMOLOGIA</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="101" name="FinalesOftalmologia" value="101">
          <label for="101">CONTROL OFTALMOLOGIA</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
    </td>
