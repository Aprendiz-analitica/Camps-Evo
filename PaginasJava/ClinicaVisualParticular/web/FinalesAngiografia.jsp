...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=FinalesAngiografia]:checked').val()
                ...
                switch (idfinal) {
                    case "218":
                        desfinal = "ANGIOGRAFIA SEGMENTO POSTERIOR";
                        break;
                    case "219":
                        desfinal = "FOTOGRAFIA SEGMENTO POSTERIOR";
                        break;
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES ANGIOGRAFÍA</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="FinalesAngiografia" value="0" hidden = "true" checked >  
        <input type="radio" id="218" name="FinalesAngiografia" value="218">
          <label for="218">ANGIOGRAFIA SEGMENTO POSTERIOR</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="219" name="FinalesAngiografia" value="219">
          <label for="219">FOTOGRAFIA SEGMENTO POSTERIOR</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
    </td>
