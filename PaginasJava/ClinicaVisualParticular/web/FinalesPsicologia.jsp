...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=FinalesPsicologia]:checked').val()
                ...
                switch (idfinal) {
                    case "209":
                        desfinal = "EVALUACIÓN PSICOLOGICA";
                        break;
                    case "210":
                        desfinal = "TERAPIA PSICOLOGICA";
                        break;
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES PSICOLOGIA</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="FinalesPsicologia" value="0" hidden = "true" checked >  
        <input type="radio" id="209" name="FinalesPsicologia" value="209">
          <label for="209">EVALUACIÓN PSICOLOGICA</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="210" name="FinalesPsicologia" value="210">
          <label for="210">TERAPIA PSICOLOGICA</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
    </td>
