...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=FinalesBiometria]:checked').val()
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES BIOMETRÍA</th>
        </tr>
...
<tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="FinalesBiometria" value="0" hidden = "true" checked >  
        <input type="radio" id="116" name="FinalesBiometria" value="116">
          <label for="116">PAQUIMETRIA</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="119" name="FinalesBiometria" value="119">
          <label for="119">TOPOGRAFIA</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="249" name="FinalesBiometria" value="249">
          <label for="249">BIOMETRIA</label><br> 
    </td>
...
<tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="122" name="FinalesBiometria" value="122">
          <label for="122">RECUENTO DE CELULAS ENDOTELIAL</label><br> 
    </td>
