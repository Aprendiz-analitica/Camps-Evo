...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=FinalesAudifonos]:checked').val()
                ...
                switch (idfinal) {
                    ...
                    case "236":
                        ...
                        break;
                    case "237":
                        desfinal = "CONTROL DE AUDIFONOS";
                        break;
                    case "238":
                        desfinal = "ADAPTACION AUDIFONOS NO VENDID";
                        break;
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES AUDIFONOS</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="FinalesAudifonos" value="0" hidden = "true" checked >  
        <input type="radio" id="234" name="FinalesAudifonos" value="234">
          <label for="234">ENTREGA</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="235" name="FinalesAudifonos" value="235">
          <label for="235">MOLDE</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="236" name="FinalesAudifonos" value="236">
          <label for="236">COTIZACIÓN</label><br> 
    </td>
</tr>
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="237" name="FinalesAudifonos" value="237">
          <label for="237">CONTROL DE AUDIFONOS</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="238" name="FinalesAudifonos" value="238">
          <label for="238">ADAPTACIÓN DE AUDIFONOS NO VENDIDOS</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
