...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                ...
                switch (idfinal) {
                    case "200":
                        desfinal = "OFT BAJA VISION";
                        break;
                    case "201":
                        desfinal = "TERAPIA BAJA VISION";
                        break;
                    case "202":
                        desfinal = "OPTO BAJA VISION";
                        break;
                    case "259":
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="FinalesBajaVision" value="0" hidden = "true" checked >  
        <input type="radio" id="200" name="FinalesBajaVision" value="200">
          <label for="200">OFT BAJA VISION</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="201" name="FinalesBajaVision" value="201">
          <label for="201">TERAPIA BAJA VISION</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="202" name="FinalesBajaVision" value="202">
          <label for="202">OPTO BAJA VISION</label>     
    </td>
...
<tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="260" name="FinalesBajaVision" value="260">
          <label for="260">OPTO BAJA VISION</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
