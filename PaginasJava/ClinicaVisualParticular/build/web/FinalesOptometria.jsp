...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=FinalesOptometria]:checked').val()
                ...
                switch (idfinal) {
                    case "112":
                        desfinal = "PRIMERA VEZ OPTOMETRIA";
                        break;
                    case "113":
                        desfinal = "CONTROL OPTOMETRIA";
                        break;

                    case "258":
                        desfinal = "TEST DE DESLUMBRAMIENTO";
                        break;
                    case "259":
                        desfinal = "TEST DE ISHIHARA";
                        break;
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES OPTOMETRIA</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="FinalesOptometria" value="0" hidden = "true" checked >  
        <input type="radio" id="112" name="FinalesOptometria" value="112">
          <label for="112">PRIMERA VEZ OPTOMETRIA</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="113" name="FinalesOptometria" value="113">
          <label for="113">CONTROL OPTOMETRIA</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="258" name="FinalesOptometria" value="258">
          <label for="258">TEST DE DESLUMBRAMIENTO</label><br> 
    </td>
...
<tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="259" name="FinalesOptometria" value="259">
          <label for="259">TEST DE ISHIHARA</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
