...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=FinalesTransferenciaEPS]:checked').val()
                ...
                switch (idfinal) {
                    case "161":
                        desfinal = "Transferencia a SURA";
                        break;
                    case "162":
                        desfinal = "Transferencia a SANITAS";
                        break;
                    case "163":
                        desfinal = "Transferencia a CIRUGIA";
                    case "245":
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES TRANSFERENCIA A EPS</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
         <input type="radio" id="0" name="FinalesTransferenciaEPS" value="0" hidden = "true" checked >  
        <input type="radio" id="161" name="FinalesTransferenciaEPS" value="161">
          <label for="161">TRANSFERENCIA A SURA</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
         <input type="radio" id="162" name="FinalesTransferenciaEPS" value="162">
          <label for="162">TRANSFERENCIA A SANITAS</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
         <input type="radio" id="163" name="FinalesTransferenciaEPS" value="163">
          <label for="163">TRANSFERENCIA A CIRUGIA</label>     
    </td>
</tr>
<tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="245" name="FinalesTransferenciaEPS" value="245">
          <label for="245">TRANSFERENCIA A EPS</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
