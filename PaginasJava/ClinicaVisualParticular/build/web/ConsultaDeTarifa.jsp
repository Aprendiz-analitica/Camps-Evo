...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=FinalesBajaVision]:checked').val();
                ...
                switch (idfinal) {
                    case "266":
                        desfinal = "TARIFA OFTALMOLOGIA";
                        break;
                    case "267":
                        desfinal = "TARIFA OTORRINO";
                        break;
                    case "268":
                        desfinal = "TARIFA OPTOMETRIA";
                        break;
                    case "269":
                        desfinal = "TARIFA AYUDAS DIAGNOSTICAS";
                        break;
                    case "270":
                        desfinal = "TARIFA CONSULTA OTRAS";
                        break;
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES BAJA VISIÓN</th>
        </tr>
    ...
    <td style="text-align: left; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px; padding: 2px 5px">
        <input type="radio" id="0" name="FinalesOtros" value="0" hidden = "true" checked > 
        <input type="radio" id="266" name="FinalesBajaVision" value="266">
          <label for="266">TARIFA OFTALMOLOGIA</label><br>
    </td>
    <td style="text-align: left; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px; padding: 2px 5px">
        <input type="radio" id="267" name="FinalesBajaVision" value="267">
          <label for="267">TARIFA OTORRINO</label><br> 
    </td>
    <td style="text-align: left; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px; padding: 2px 5px">
        <input type="radio" id="268" name="FinalesBajaVision" value="268">
          <label for="268">TARIFA OPTOMETRIA</label>     
    </td>
</tr>

<tr>
    <td style="text-align: left; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px; padding: 2px 5px">
        <input type="radio" id="269" name="FinalesBajaVision" value="269">
          <label for="269">TARIFA AYUDAS DIAGNOSTICAS</label>     
    </td>
    <td style="text-align: left; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px; padding: 2px 5px">
        <input type="radio" id="270" name="FinalesBajaVision" value="270">
          <label for="270">TARIFA CONSULTA OTRAS</label>     
    </td>
        <td style="text-align: left; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px; padding: 2px 5px">
