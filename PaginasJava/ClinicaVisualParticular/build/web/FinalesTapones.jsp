...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                ...
                switch (idfinal) {
                    case "250":
                        desfinal = "TAPONES DE RUIDO";
                        break;
                    case "251":
                        desfinal = "TAPONES DE AGUA";
                        break;
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES TAPONES</th>
        </tr>
    </thead>
    <tbody>
        <%
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        ...
        <input type="radio" id="250" name="FinalesAngiografia" value="250">
          <label for="250">TAPONES DE RUIDO</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="251" name="FinalesAngiografia" value="251">
          <label for="251">TAPONES DE AGUA</label><br> 
    </td>
<td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
 </td>   
</tr>
