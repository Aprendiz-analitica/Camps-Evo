...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=FinalesOtorrino]:checked').val()
                ...
                switch (idfinal) {
                    ...
                    case "204":
                        ...
                        break;
                    case "205":
                        desfinal = "Larringologo";
                    case "206":
                        desfinal = "Apnea de sueño";
                        break;
                    case "207":
                        desfinal = "Otorrino general";
                        break;
                    case "208":
                        desfinal = "Otorrino pediatrico";
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES OTORRINO</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="FinalesOtorrino" value="0" hidden = "true" checked >  
        <input type="radio" id="203" name="FinalesOtorrino" value="203">
          <label for="203">OTOLOGO</label><br>
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="204" name="FinalesOtorrino" value="204">
          <label for="204">RINOLOGO</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="205" name="FinalesOtorrino" value="205">
          <label for="205">LARRINGOLOGO</label>     
    </td>
</tr>
<tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="206" name="FinalesOtorrino" value="206">
          <label for="206">APNEA DE SUEÑO</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="207" name="FinalesOtorrino" value="207">
          <label for="207">OTORRINO GENERAL</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="208" name="FinalesOtorrino" value="208">
          <label for="208">OTORRINO PEDIATRICO</label>     
    </td>
</tr>
