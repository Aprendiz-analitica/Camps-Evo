...
<body>    
            <div id="wrapper">
            <form name="login-form" class="login-form" action="Indice.jsp" method="post">
                <div class="header" style="text-align: center;">
                    <img style="position:relative;" src="logo-constructora-bolivar.svg" alt="ConstructoraBolivar" >
                </div>
                <div class="content" style="text-align: center;">
                    ...
                    <select class="input username" name="desfinal" style="width: 240.21px;">
                        <option value="100000276">LEADS DESCALIFICADOS</option>
                        <option value="100000054">LEADS INTERNACIONAL</option>
                        <option value="100000196">LEADS INTERNACIONALES RETOMA</option>
                        <option value="100000123">LEADS NACIONALES</option>
                        <option value="100000176">LEADS NACIONALES RETOMA</option>
                        <option value="100000273">LEADS REINCIDENTES</option>
                        <option value="100000236">REMARKETING LEADS</option>
                    </select>
                </div>
