...
<html>
            ...
            function actualizar() {
                ...
                switch (idfinal) {
                    ...
                    case "601":
                        ...
                        break;
                    case "602":
                        desfinal = "LLAMADA EQUIVOCADA";
                        break;
                    case "603":
                        desfinal = "FALLA EN EL SISTEMA";
                        break;
                    case "604":
                        desfinal = "FINALIZADA POR EL SISTEMA";
                        break;
                    case "606":
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        ...
        <input type="radio" id="600" name="Otros" value="600">
          <label for="600">LLAMADA CAIDA</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="601" name="Otros" value="601">
          <label for="601">LLAMADA DE PRUEBA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="602" name="Otros" value="602">
          <label for="602">LLAMADA EQUIVOCADA</label>     
    </td>

</tr>
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="603" name="Otros" value="603">
          <label for="603">FALLA EN EL SISTEMA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="604" name="Otros" value="604">
          <label for="604">FINALIZADA POR EL SISTEMA</label>     
    </td>

    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="606" name="Otros" value="606">
          <label for="606">LLAMADA MUDA</label>     
    </td>
</tr>
