...
<html>
    <head>
        ...
        <title>Llamadas Abandonadas Historico</title>
        ...
        %>
        <%String titulo = "LLAMADAS ABANDONADAS DESDE EL " + fechaIn + " HASTA EL " + fechaFin;%>
        ...
        <table id="dataTable" class="table table-striped table-bordered" style="color: #fcfaf9">
            ...
            <tbody>
                ...
                <%
                    try {
                        ...
                        String sql1
                                ...
                                + "    t.tCreacion, "
                                + "    t.sDescripcionFinal, "
                                + "    CAST((STUFF((SELECT  DISTINCT(';' + sOrigen) from tbHistoFContactos con WITH (NOLOCK) WHERE con.idTransaccion=t.idTransaccion and  ntipo=1 and nSentido=1 FOR XML PATH('')), 1, 1, '')) AS VARCHAR)  as Origen, "
                                + "    t.sIdOriginal as cedula, "
                                + "    (Select top(1) NOMBRE from CAMPANYA where idCampanya = t.idCampanya) AS Campanya "
                                + "FROM "
                                + "    tbHistoFTransacciones t "
                                + "WHERE "
                                + "    t.idFinal = 10 "
                                + "    AND t.idCampanya IN (100000362,100000365,100000364,100000363) "
                                + "    AND t.tCreacion BETWEEN '" + fechaIn + "T00:00:00' AND '" + fechaFin + "T23:59:59' ";
                ...
                <tr>
                    ...
                    <td><%=rs1.getString("sDescripcionFinal")%></td>
                    <td><%=rs1.getString("Origen")%></td>
                    <td><%=rs1.getString("cedula")%></td>
                    <td><%=rs1.getString("Campanya")%></td>   
                </tr> 
