...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=Optometria]:checked').val()
                ...
                switch (idfinal) {
                    ...
                    case "400":
                        desfinal = "PROTESIS OCULAR";
                        break;
                    case "401":
                        desfinal = "PRIMERA OPTOMETRIA";
                        break;
                    case "402":
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="Optometria" value="0" hidden = "true" checked > 
        <input type="radio" id="400" name="Optometria" value="400">
          <label for="400">PROTESIS OCULAR</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="401" name="Optometria" value="401">
          <label for="401">PRIMERA OPTOMETRIA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="402" name="Optometria" value="402">
          <label for="402">CONTROL OPTOMETRIA</label>     
    </td>
