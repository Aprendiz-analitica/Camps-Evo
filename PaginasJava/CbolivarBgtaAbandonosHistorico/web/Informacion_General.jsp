...
<html>
    <table class="formulario" style="width:100%;">        
            ...
            function actualizar() {
                ...
                switch (idfinal) {
                    ...
                    case "1300":
                        ...
                        break;
                    case "1301":
                        desfinal = "HORARIOS DE ATENCION/DIRECCION";
                        break;
                    case "1302":
                        desfinal = "DAÑO EN EQUIPO";
                        break;
                    case "1303":
                        desfinal = "DIRECCIONAMIENTO PRESENCIAL";
                        break;
                    case "1304":
                        desfinal = "SOLICITUD HISTORICA CLINICA";
                        break;
                    case "1305":
                        desfinal = "OTROS REQUERIMIENTOS";
                        break;
                    case "1306":
                        desfinal = "CIRUGIA";
                        break;
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES - INFORMACION GENERAL</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        ...
        <input type="radio" id="1300" name="Informacion_General" value="1300">
          <label for="1300">DATOS INCOMPLETOS</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="1301" name="Informacion_General" value="1301">
          <label for="1301">HORARIOS DE ATENCION/DIRECCION</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="1302" name="Informacion_General" value="1302">
          <label for="1302">DAÑO EN EQUIPO</label>     
    </td>

</tr>
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="1303" name="Informacion_General" value="1303">
          <label for="1303">DIRECCIONAMIENTO PRESENCIAL</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="1304" name="Informacion_General" value="1304">
          <label for="1304">SOLICITUD HISTORICA CLINICA</label>     
    </td>

    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="1305" name="Informacion_General" value="1305">
          <label for="1305">OTROS REQUERIMIENTOS</label>     
    </td>
</tr>
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">

        <input type="radio" id="1306" name="Informacion_General" value="1306">
          <label for="1306">CIRUGIA</label><br>
    </td>
