...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=Transferencia_EPS]:checked').val()
                ...
                switch (idfinal) {
                    ...
                    case "300":
                        desfinal = "TRANSFERENCIA PARTICULAR";
                        break;      
                }
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES - TRANSFERENCIA PARTICULAR</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="Transferencia_EPS" value="0" hidden = "true" checked > 
        <input type="radio" id="300" name="Transferencia_EPS" value="300">
          <label for="300">TRANSFERENCIA PARTICULAR</label><br> 
    </td>
