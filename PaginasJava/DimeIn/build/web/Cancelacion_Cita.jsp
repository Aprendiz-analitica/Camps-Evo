...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=Cancelacion_Cita]:checked').val()
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES - CANCELACIÓN CITA</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="Cancelacion_Cita" value="0" hidden = "true" checked > 
        <input type="radio" id="600" name="Cancelacion_Cita" value="600">
          <label for="600">CANC CITAS CARDIOLOGIA</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="601" name="Cancelacion_Cita" value="601">
          <label for="601">CANC CITAS CONSULTA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="602" name="Cancelacion_Cita" value="602">
...
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="603" name="Cancelacion_Cita" value="603">
          <label for="603">CANC CITAS PROC CARDIOLOGIA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="604" name="Cancelacion_Cita" value="604">
          <label for="604">CANC CITAS UNIDAD DIGESTIVA</label>     
    </td>

    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="605" name="Cancelacion_Cita" value="605">
...
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        ...
        <input type="radio" id="606" name="Cancelacion_Cita" value="606">
          <label for="606">CANC CITA PROC NEUMOLOGIA</label><br>
    </td>

    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="607" name="Cancelacion_Cita" value="607">
          <label for="607">CANC CITAS FONOAUDIOLOGÍA</label>     
    </td>
    
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="608" name="Cancelacion_Cita" value="608">
          <label for="608">CANC CITAS RAYOS X</label>     
    </td>
