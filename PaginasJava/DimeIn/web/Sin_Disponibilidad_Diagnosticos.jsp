...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES - SIN DISPONIBILIDAD DIAGNOSTICOS</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        ...
        <input type="radio" id="2800" name="Cancelacion_Cita" value="2800">
          <label for="2800">SD DENSITOMETRIA</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="2801" name="Cancelacion_Cita" value="2801">
          <label for="2801">SD ECOGRAFIA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="2802" name="Cancelacion_Cita" value="2802">
          <label for="2802">SD ESCANOGRAFIA</label>     
    </td>

</tr>
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="2803" name="Cancelacion_Cita" value="2803">
          <label for="2803">SD MAMOGRAFIA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="2804" name="Cancelacion_Cita" value="2804">
          <label for="2804">SD RESONANCIA</label>     
    </td>

    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="2805" name="Cancelacion_Cita" value="2805">
          <label for="2805">SD POLISOMNOGRAFIA</label>     
    </td>
</tr>
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">

        <input type="radio" id="2807" name="Cancelacion_Cita" value="2807">
          <label for="2807">SD RAYOS X</label><br>
    </td>
