        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FinalesAC]:checked').val()
                    ...
                    switch(idfinal){
                        case "150":
                            desfinal = "APP COMFENALCO";
                        break;
                        case "151":
                            desfinal = "ATENCION AL CLIENTE";
                        break;
                        case "152":
                            desfinal = "TARJETA COMFENALCO";
                        break;
            ...
            <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
                <th colspan="3">FINALES ATENCIÓN AL CLIENTE</th>
            </tr>
        </thead>
        <tbody>
            <%
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                    <input type="radio" id="0" name="FinalesAC" value="0" hidden = "true" checked >  
                    <input type="radio" id="150" name="FinalesAC" value="150">
                      <label for="150">APP COMFENALCO</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="151" name="FinalesAC" value="151">
                      <label for="151">ATENCION AL CLIENTE</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="152" name="FinalesAC" value="152">
                      <label for="152">TARJETA COMFENALCO</label>     
                </td>
            </tr>
            <tr>
