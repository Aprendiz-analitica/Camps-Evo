        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FinalesTransfer]:checked').val()
                    ...
                    switch(idfinal){
                        case "1516":
                            desfinal = "TRANSFERENCIA SAC";
                        break;
                        case "1517":
                            desfinal = "TRANSFERENCIA A COMFEWEB";
                        break;
                        case "1518":
                            desfinal = "TRANSFERENCIA A OFICINA JURI";
                        break;
            ...
            <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
                <th colspan="3">FINALES TRANSFERENCIAS</th>
            </tr>
        </thead>
        <tbody>
            <%
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="1516" name="FinalesTransfer" value="1516">
                      <input type="radio" id="0" name="FinalesTransfer" value="0" hidden = "true" checked >
                      <label for="1516">TRANSFERENCIA SAC</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="1517" name="FinalesTransfer" value="1517">
                      <label for="1517">TRANSFERENCIA A COMFEWEB</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="1518" name="FinalesTransfer" value="1518">
                      <label for="1518">TRANSFERENCIA A OFICINA JURIDI</label>     
                </td>
            </tr>
            <tr>
