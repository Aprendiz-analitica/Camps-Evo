        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FinalesCC]:checked').val()
                    ...
                    switch(idfinal){
                        case "250":
                            desfinal = "APORTES CARTERA";
                        break;
                        case "251":
                            desfinal = "CIUDAD ESCOLAR COMFENA CARTERA";
                        break;
                        case "252":
                            desfinal = "CREDITO";
                        break;
            ...
            <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
                <th colspan="3">FINALES CARTERA CORPORATIVA</th>
            </tr>
        </thead>
        <tbody>
            <%
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                    ...
                    <input type="radio" id="250" name="FinalesCC" value="250">
                      <label for="250">APORTES CARTERA</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                    <input type="radio" id="251" name="FinalesCC" value="251">
                      <label for="251">CIUDAD ESCOLAR COMFENA CARTERA</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                    <input type="radio" id="252" name="FinalesCC" value="252">
                      <label for="252">CREDITO</label>     
                </td>
            </tr>
            <tr>
