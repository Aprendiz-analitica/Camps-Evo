        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FinalesLSG]:checked').val()
                    ...
                    switch(idfinal){
                        case "1350":
                            desfinal = "LLAMADAS DE PRUEBA";
                        break;
                        case "1351":
                            desfinal = "LLAMADAS SIN AUDIO";
                        break;
                        case "1352":
                            desfinal = "LLAMADA EQUIVOCADAS";
                        break;
            ...
            <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
                <th colspan="3">FINALES LLAMADAS SIN GESTION</th>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="1350" name="FinalesLSG" value="1350">
                      <input type="radio" id="0" name="FinalesLSG" value="0" hidden = "true" checked >
                      <label for="1350">LLAMADAS DE PRUEBA</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="1351" name="FinalesLSG" value="1351">
                      <label for="1351">LLAMADAS SIN AUDIO</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="1352" name="FinalesLSG" value="1352">
                      <label for="1352">LLAMADA EQUIVOCADAS</label>     
                </td>
            </tr>
            <tr>
