        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FinalesDEP]:checked').val()
                    ...
                    switch(idfinal){
                        case "550":
                            desfinal = "CLUB DEPORTIVO";
                        break;
                        case "551":
                            desfinal = "ESCUELA DEPORTIVA";
                        break;
                        case "552":
                            desfinal = "ESPACIOS DEPORTIVOS";
                        break;
                        case "554":
                            desfinal = "EVENTOS DEPORTIVOS";
                        break;
            ...
            <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
                <th colspan="3">FINALES DEPORTES</th>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="550" name="FinalesDEP" value="550">
                      <input type="radio" id="0" name="FinalesDEP" value="0" hidden = "true" checked >
                      <label for="550">CLUB DEPORTIVO</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="551" name="FinalesDEP" value="551">
                      <label for="551">ESCUELA DEPORTIVA</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="552" name="FinalesDEP" value="552">
                      <label for="552">ESPACIOS DEPORTIVOS</label>     
                </td>
            </tr>
            <tr>
                <input id="idllamada" type="hidden" name="idllamada"  value="<%=idcall%>">
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="554" name="FinalesDEP" value="554">
                      <label for="554">EVENTOS DEPORTIVOS</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
