    ...
    <table class="formulario" style="width:100%;">        
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FinalesEC]:checked').val()
                    ...
                    switch(idfinal){
                        case "450":
                            desfinal = "ESCUELA DE MÚSICA Y ARTES";
                        break;
                        case "451":
                            desfinal = "CEDESARROLLO";
                        break;
                        case "452":
                            desfinal = "CIUDAD ESCOLAR COMFENALCO";
                        break;
                        case "453":
                            desfinal = "DRLLO Y RELACIONES EMPRESARIAL";
                        break;
                    }
            ...
            <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
                <th colspan="3">FINALES EDUCACION Y CULTURA</th>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      
                    <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="450" name="FinalesEC" value="450">
                      <input type="radio" id="0" name="FinalesEC" value="0" hidden = "true" checked >
                      <label for="450">ESCUELA DE MÚSICA Y ARTES</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      
                    <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="451" name="FinalesEC" value="451">
                      <label for="451">CEDESARROLLO</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">     
                    <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="452" name="FinalesEC" value="452">
                      <label for="452">CIUDAD ESCOLAR COMFENALCO</label>     
                </td>
            </tr>
            <tr>
                <input id="idllamada" type="hidden" name="idllamada"  value="<%=idcall%>">
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">      
                    <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="453" name="FinalesEC" value="453">
                      <label for="453">DRLLO Y RELACIONES EMPRESARIAL</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">      
                    <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                </td>
