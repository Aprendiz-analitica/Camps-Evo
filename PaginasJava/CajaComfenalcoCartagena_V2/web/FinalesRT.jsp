        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FinalesRT]:checked').val()
                    ...
                    switch(idfinal){
                        case "950":
                            desfinal = "CENTRO EMPRESARIAL";
                        break;
                        case "951":
                            desfinal = "CENTRO RECREACIONAL MAGANGUE";
                        break;
                        case "952":
                            desfinal = "JARDIN BOTANICO GUILLERMO PINE";
                        break;
                        case "953":
                            desfinal = "HOTEL CORALES DE INDIAS";
                        break;
                        case "954":
                            desfinal = "PLANES TURISTICOS";
                        break;
                        case "955":
                            desfinal = "TAKURIKA";
                        break;
            ...
            <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
                <th colspan="3">FINALES RECREACION Y TURISMO</th>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="950" name="FinalesRT" value="950">
                      <input type="radio" id="0" name="FinalesRT" value="0" hidden = "true" checked >
                      <label for="950">CENTRO EMPRESARIAL</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="951" name="FinalesRT" value="951">
                      <label for="951">CENTRO RECREACIONAL MAGANGUE</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="952" name="FinalesRT" value="952">
                      <label for="952">JARDIN BOTANICO GUILLERMO PINE</label>     
                </td>
            </tr>
            <tr>
                <input id="idllamada" type="hidden" name="idllamada"  value="<%=idcall%>">
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="953" name="FinalesRT" value="953">
                      <label for="953">HOTEL CORALES DE INDIAS</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="954" name="FinalesRT" value="954">
                      <label for="954">PLANES TURISTICOS</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="955" name="FinalesRT" value="955">
                      <label for="955">TAKURIKA</label>     
                </td>
            </tr>            
            <tr>
