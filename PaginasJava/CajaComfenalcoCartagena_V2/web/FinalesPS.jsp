        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FinalesPS]:checked').val()
                    ...
                    switch(idfinal){
                        case "850":
                            desfinal = "DISCAPACIDAD";
                        break;
                        case "851":
                            desfinal = "ADULTO MAYOR";
                        break;
                        case "852":
                            desfinal = "ATENCION INTEGRAL A LA NIÑEZ";
                        break;
                        case "854":
                            desfinal = "JORNADA ESCOLAR COMPLEMENTARIA";
                        break;
            ...
            <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
                <th colspan="3">FINALES PROTECCION SOCIAL</th>
            </tr>
        </thead>
        <tbody>
            <%
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="850" name="FinalesPS" value="850">
                      <input type="radio" id="0" name="FinalesPS" value="0" hidden = "true" checked >
                      <label for="850">DISCAPACIDAD</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="851" name="FinalesPS" value="851">
                      <label for="851">ADULTO MAYOR</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="852" name="FinalesPS" value="852">
                      <label for="852">ATENCION INTEGRAL A LA NIÑEZ</label>     
                </td>
            </tr>
            <tr>
                <input id="idllamada" type="hidden" name="idllamada"  value="<%=idcall%>">
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="854" name="FinalesPS" value="854">
                      <label for="854">JORNADA ESCOLAR COMPLEMENTARIA</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
