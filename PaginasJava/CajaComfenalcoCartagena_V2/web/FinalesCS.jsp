        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FinalesCS]:checked').val()
                    ...
                    switch(idfinal){
                        case "350":
                            desfinal = "CUPOCREDITO";
                        break;
                        case "351":
                            desfinal = "LIBRANZA";
                        break;
                        case "352":
                            desfinal = "LINEAEXPRESS";
                        break;
            ...
            <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
                <th colspan="3">FINALES CREDITO SOCIAL</th>
            </tr>
        </thead>
        <tbody>
            <%
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="350" name="FinalesCS" value="350">
                      <input type="radio" id="0" name="FinalesCS" value="0" hidden = "true" checked >
                      <label for="350">CUPOCREDITO</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="351" name="FinalesCS" value="351">
                      <label for="351">LIBRANZA</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px;">      <input type="radio" id="0" name="FinalesCC" value="0" hidden = "true" checked >   
                      <input type="radio" id="352" name="FinalesCS" value="352">
                      <label for="352">LINEAEXPRESS</label>     
                </td>
            </tr>
            <tr>
