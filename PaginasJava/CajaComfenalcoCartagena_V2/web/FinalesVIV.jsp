        ...
        <thead>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function actualizar() {
                    idfinal = $('input:radio[name=FinalesVIV]:checked').val()
                    ...
                    switch(idfinal){
                        case "1150":
                            desfinal = "FOVIS - AFILIADO";
                        break;
                        case "1151":
                            desfinal = "PROYECTOS DE VIVIENDA";
                        break;
                        case "1152":
                            desfinal = "SUBSIDIO VIVIENDA";
                        break;
            ...
            <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
                <th colspan="3">FINALES VIVIENDA</th>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="1150" name="FinalesVIV" value="1150">
                      <input type="radio" id="0" name="FinalesVIV" value="0" hidden = "true" checked>
                      <label for="1150">FOVIS - AFILIADO</label><br>
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="1151" name="FinalesVIV" value="1151">
                      <label for="1151">PROYECTOS DE VIVIENDA</label><br> 
                </td>
                <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">                    
                      <input type="radio" id="1152" name="FinalesVIV" value="1152">
                      <label for="1152">SUBSIDIO VIVIENDA</label>     
                </td>
            </tr>
            <tr>
