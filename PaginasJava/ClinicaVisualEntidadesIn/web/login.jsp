...
<html>
    ...
    <body>
        ...
        <%    try {
                ...
                Connection conn = DriverManager.getConnection("jdbc:sqlserver://172.10.1.83:1433;DatabaseName=EVOLUTIONDB", "analitica", "Fenalco2023*..");
                ...
                if (rs.next()) {
                    ...
                    // Validar tipo de usuario (Agente o Supervisor)
                    if (tipousuario == 1 || tipousuario == 5 ) {
                        response.sendRedirect("Manager.jsp");
                    } else {
                        response.sendRedirect("Indice.jsp?codigoagente=" + idusuario + "&nom=" + nusuario + "&apel=" + ausuario);
                    }
