...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=Otorrino]:checked').val()
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="Otorrino" value="0" hidden = "true" checked > 
        <input type="radio" id="500" name="Otorrino" value="500">
          <label for="500">OTORRINO GENERAL</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="501" name="Otorrino" value="501">
          <label for="501">RINOLOGO</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="502" name="Otorrino" value="502">
          <label for="502">OTOLOGO</label>     
    </td>

</tr>
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="503" name="Otorrino" value="503">
          <label for="503">OTORRINO PEDIATRICO</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="504" name="Otorrino" value="504">
          <label for="504">LARRINGOLOGO</label>     
    </td>
