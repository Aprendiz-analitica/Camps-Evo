...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=Ayuda_Diagnosticas_Audiologia]:checked').val()
                ...
                switch (idfinal) {
                    ...
                    case "700":
                        desfinal = "AUDIOMETRIA";
                        break;
                    case "701":
                        desfinal = "IMPEDANCIOMETRIA";
                        break;
                    case "702":
                        desfinal = "LOGOAUDIOMETRIA";
                        break;
                    case "703":
                        desfinal = "ACUFENOMETRIA";
                        break;
                    case "704":
                        desfinal = "OTOEMESIONES";
                        break;
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES - AYUDA DIAGNOSTICAS AUDIOLOGIA </th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="Ayuda_Diagnosticas_Audiologia" value="0" hidden = "true" checked > 
        <input type="radio" id="700" name="Ayuda_Diagnosticas_Audiologia" value="700">
          <label for="600">AUDIOMETRIA</label><br> 
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="701" name="Ayuda_Diagnosticas_Audiologia" value="701">
          <label for="701">IMPEDANCIOMETRIA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="702" name="Ayuda_Diagnosticas_Audiologia" value="702">
          <label for="702">LOGOAUDIOMETRIA</label>     
    </td>

</tr>
<tr>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="703" name="Ayuda_Diagnosticas_Audiologia" value="703">
          <label for="703">ACUFENOMETRIA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="704" name="Ayuda_Diagnosticas_Audiologia" value="704">
          <label for="704">OTOEMESIONES</label>     
    </td>
</tr>
