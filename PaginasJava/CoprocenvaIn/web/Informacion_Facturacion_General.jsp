...
<html>
    <table class="formulario" style="width:100%;">        
        ...
        <script>
            ...
            function actualizar() {
                idfinal = $('input:radio[name=Informacion_Facturacion_General]:checked').val()
                ...
                switch (idfinal) {
                    ...
                    case "180":
                        desfinal = "INFO FACTURACION GENERAL";
                        break;
        ...
        <tr style="font-weight: bold; font-family: Lato; color: white; background-color: #ed7203;font-size: 18px; border : 1px solid #ed7203; width: 100% ;height: 50px">
            <th colspan="3">FINALES - INFORMACION_FACTURACION_GENERAL</th>
        </tr>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="0" name="Informacion_Facturacion_General" value="0" hidden = "true" checked > 
        <input type="radio" id="180" name="Informacion_Facturacion_General" value="180">
          <label for="180">INFO FACTURACION GENERAL</label><br> 
    </td>
