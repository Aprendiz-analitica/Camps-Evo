...
<html>
    ...
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        ...
        <input type="radio" id="117" name="Otros" value="117">
          <label for="117">LLAMADA SIN AUDIO</label><br> 
    </td> 
        <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="204" name="Otros" value="204">
          <label for="204">LLAMADA DE PRUEBA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="305" name="Otros" value="305">
          <label for="305">LLAMADA EFECTIVA</label>     
    </td>
<tr> 
...
<tr> 
     ...
     <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="195" name="Otros" value="195">
          <label for="195">LLAMADA EQUIVOCADA</label>     
    </td>
    <td style="text-align: center; font-weight: bold; font-family: Lato; color: grey; border : 1px solid #ed7203; height: 50px; width: 259px">
        <input type="radio" id="221" name="Otros" value="221">
          <label for="221">LLAMADA CAIDA</label>     
