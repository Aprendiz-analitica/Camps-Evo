...
<html>
    <head>
        ...
        <title>DIME tipificaciones</title>
    ...
    <body>
        ...
        <%    try {
                ...
                if (rs.next()) {
                    idagente= rs.getString("IDUSUARIO");
                    nagente= rs.getString("NOMBRE");
                    aagente= rs.getString("APELLIDO1");
                    // Las credenciales son válidas, redirigir al usuario a la página de bienvenida
                    response.sendRedirect("Indice.jsp?codigoagente="+idagente+"&nom="+nagente+"&apel="+aagente);
                }else {
