        ...
        <tbody>
           ...
           <td class="campoti" 
                    ...
                    <asp:DropDownList ID="Grupo" runat="server" 
                        ...
                        <asp:ListItem Value="1">OFTALMOLOGIA</asp:ListItem>
                        <asp:ListItem Value="2">OPTOMETRÍA</asp:ListItem>
                        <asp:ListItem Value="3">OTORRINO</asp:ListItem>
                        <asp:ListItem Value="4">OTROS</asp:ListItem>
                        <asp:ListItem Value="5">AYUDA DIAGNOSTICAS AUDIOLOGIA</asp:ListItem>
                        <asp:ListItem Value="6">BAJA VISIÓN</asp:ListItem>
                        <asp:ListItem Value="7">AUDIFONOS</asp:ListItem>
                        <asp:ListItem Value="8">AYUDAS DIAGNOSTICAS OFTALMOLOGIA</asp:ListItem>
                        <asp:ListItem Value="9">AYUDAS DIAGNOSTICAS OTORRINO</asp:ListItem>
                        <asp:ListItem Value="10">FONOAUDIOLOGIA</asp:ListItem>
                        <asp:ListItem Value="11">INFORMACION GENERAL</asp:ListItem>
                        <asp:ListItem Value="12">DATOS INCOMPLETOS</asp:ListItem>
                    </asp:DropDownList>
...
<script runat="server">
    ...
    Protected Sub Grupo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Grupo.SelectedValue = "1" Then
            sSql += " AND IDFINAL BETWEEN 100 AND 199"
        ElseIf Grupo.SelectedValue = "2" Then
            sSql += " AND IDFINAL BETWEEN 200 AND 299"
        ElseIf Grupo.SelectedValue = "3" Then
            sSql += " AND IDFINAL BETWEEN 300 AND 399"
        ElseIf Grupo.SelectedValue = "4" Then
            sSql += " AND IDFINAL BETWEEN 400 AND 499"
        ElseIf Grupo.SelectedValue = "5" Then
            sSql += " AND IDFINAL BETWEEN 500 AND 599"
        ElseIf Grupo.SelectedValue = "6" Then
            sSql += "AND IDFINAL BETWEEN 600 AND 699"
        ElseIf Grupo.SelectedValue = "7" Then
            sSql += " AND IDFINAL BETWEEN 700 AND 799"
        ElseIf Grupo.SelectedValue = "8" Then
            sSql += " AND IDFINAL BETWEEN 800 AND 899"
        ElseIf Grupo.SelectedValue = "9" Then
            sSql += " AND IDFINAL BETWEEN 900 AND 999"
        ElseIf Grupo.SelectedValue = "10" Then
            sSql += " AND IDFINAL BETWEEN 1000 AND 1099"
        ElseIf Grupo.SelectedValue = "11" Then
            sSql += " AND IDFINAL BETWEEN 1100 AND 1199"
        ElseIf Grupo.SelectedValue = "12" Then
            sSql += " AND IDFINAL BETWEEN 1400 AND 1499"
        End If
