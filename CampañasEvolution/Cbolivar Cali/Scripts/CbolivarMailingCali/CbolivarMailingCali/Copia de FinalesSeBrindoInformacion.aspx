            ...
            <tr>
                <td class="style1" 
                    ...
                    Observaciones:<evo:DatosCliente_TextBox 
                        ...
                        Clave="ObservacionesSBI" TipoTextBox="MultiLine" 
            ...
            <tr>
                <td class="style1" 
                    ...
                    <asp:Button ID="Button1" runat="server" BackColor="#249E6B" 
                        ...
                        onclick="Button1_Click" Text="Recibe Información y agradece" Width="160px" />
                </td>
            </tr>
        </tbody>
    </table>          
