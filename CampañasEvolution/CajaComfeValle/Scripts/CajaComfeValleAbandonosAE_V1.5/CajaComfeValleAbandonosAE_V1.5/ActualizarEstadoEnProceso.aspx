...
<%
    ...
    sqlComm.CommandText = "UPDATE __Gestion_Abandonos SET estado = 'En Proceso', idAgente = '" + idAgente + "', idTransactionGestion = '" + idTransaccion + "'  WHERE idTransactionOriginal = '" + idTransaccionOriginal + "'"
