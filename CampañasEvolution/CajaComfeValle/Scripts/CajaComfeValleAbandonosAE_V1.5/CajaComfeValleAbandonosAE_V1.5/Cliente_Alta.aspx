<%@ Page language="VB" %>
 ...
 <%
     ...
     Dim IdOriginal As String = Request.QueryString("documento").ToString()
     Dim Telefono As String = Request.QueryString("telefono").ToString()
     Dim Nombre1 As String = Request.QueryString("nombre").ToString()
     Dim Apellido1 As String = Request.QueryString("apellido").ToString()
