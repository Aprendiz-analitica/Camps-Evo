...
<%
    ...
    If Not String.IsNullOrWhiteSpace(Extension) Then
        ...
        Using client As New ICR.Comun.ICR.Ami.AmiClient("172.10.0.200", 5038, "evolution", "bomber")
            ...
            If client.ChanSpy(ICR.Comun.ICR.Ami.AmiClient.ChanSpyMode.Barge, "local/2006*00" + Gestion.Transaccion.IdTransaccion.ToString + "@from-internal", "PJSIP/" + Extension + "-", True) Then
