...
<ControlStyle Font-Size="16px"></ControlStyle>
    ...
    <br />
    <asp:Button ID="SinRegistroCallBack" runat="server" BackColor="#249E6B " 
        BorderColor="#249E6B " Height="30px" onclick="Cambio_OnClick" 
        Text="SIN REGISTROS DE CALLBACK" Width="225px" />
    </asp:Content>
...
<script runat="server">
    ...
    Protected Sub Cambio_OnClick(ByVal sender As Object, ByVal e As System.EventArgs)
