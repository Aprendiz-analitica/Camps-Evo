...
<script runat="server">
    ...
    Protected Sub insertsacpqrs(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Response.Redirect("~/Inserttablecomer.aspx?idoriginal=" + idoriginal + "&Nombre1=" + Nombre1 + "&Nombre2=" + Nombre2 + "&Apellido1=" + Apellido1 + "&Apellido2=" + Apellido2 + "&tip1=" + tip1 + "&tip2=" + tip2 + "&tip6=" + tip6 + "&proyect=" + proyect + "&agrupacio=" + agrupacio + "&product=" + product + "&descripcio=" + descripcio + "&tipificacion=" + tipificacion + "&sede=" + sede + "&idinfobip=" + id_infobip)
    End Sub
