...
<%
    ...
    sqlComm.CommandText = "INSERT INTO __tipCbolivarbgta_sac_pqrs(idtransaccion,numdoc,name,name2,lastname,lastname2,t1,t2,t6,Proyecto,Agrupacion,Producto,Descripcion,checkcomunicado,sede,idinfobip) VALUES ('" + idcall + "','" + idoriginal + "','" + Nombre1 + "','" + Nombre2 + "','" + Apellido1 + "','" + Apellido2 + "','" + tip1 + "','" + tip2 + "','" + tip6 + "','" + proyect + "','" + agrupacio + "','" + product + "','" + descripcio + "','" + check + "','" + sede + "','" + idinfobip + "')"
