...
<%
    ...
    Dim Observaciones As String = Request.QueryString("descripcion").ToString()
    ...
    Dim momento As String = "BGTA Pagina Web"
    Dim necesidad As String = "BGTA Pagina Web"
    Dim actividad As String = "BGTA Pagina Web"
    Dim razon As String = "BGTA Pagina Web"
    conn.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("ConnectionString").ToString
    conn.Open()
    sqlComm.Connection = conn
    sqlComm.CommandType = Data.CommandType.Text
    sqlComm.CommandText = "INSERT INTO __tipCbolivarbgta_sac_pqrs(idtransaccion,numdoc,name,name2,lastname,lastname2,t1,t4,t5,t6,t7,Descripcion) VALUES ('" + idcall + "','" + idoriginal + "','" + Nombre1 + "','" + Nombre2 + "','" + Apellido1 + "','" + Apellido2 + "','" + tip1 + "','" + momento + "','" + necesidad + "','" + razon + "','" + actividad + "','" + Observaciones + "')"
