        ...
        <tbody>            
            ...
            <tr>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
                    Origen caso:<br />
                    <asp:DropDownList ID="t1" runat="server" Width="94%" ForeColor="Black">
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
                    area / Programa:<br />
                    <asp:DropDownList ID="t2" runat="server" Width="94%" ForeColor="Black">
                                            <asp:ListItem></asp:ListItem>
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
                    Tipo de llamada:<br />
                    <asp:DropDownList ID="t3" runat="server" Width="94%" ForeColor="Black">
                    <asp:ListItem></asp:ListItem>
            ...
            <tr>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;"
                    ...
                    <asp:DropDownList ID="t5" runat="server" Width="94%" ForeColor="Black">
                                            <asp:ListItem></asp:ListItem>
...
<asp:ListItem Value="Suspender inscripcion a la convocatoria">Suspender inscripcion a la convocatoria </asp:ListItem>
            ...
            <tr>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
                    Se escalaria a:<br />
                    <asp:DropDownList ID="t6" runat="server" Width="94%" ForeColor="Black">
                    <asp:ListItem></asp:ListItem>
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
                    Aplicativo:<br />
                    <asp:DropDownList ID="t7" runat="server" Width="94%" ForeColor="Black">
                        <asp:ListItem></asp:ListItem>
                ...
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
                    ...
                    <asp:DropDownList ID="t8" runat="server" Width="94%" ForeColor="Black">
                    <asp:ListItem></asp:ListItem>
            ...
            <tr>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;"
                    ...
                    Descripcion:<br />
                    <asp:TextBox ID="Descripcion" runat="server" Width="94%" Height="50px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="padding: 10px 20px 10px 20px; border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 16px;">
