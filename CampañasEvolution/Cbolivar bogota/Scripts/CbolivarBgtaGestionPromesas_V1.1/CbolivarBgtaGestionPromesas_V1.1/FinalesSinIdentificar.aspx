...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
  ...
  $(document).ready(function() {
    ...
    function llenarMicro(){
             $('#Micro option').remove();
             $("#trMicro").hide();
             var tipmacro = $("#Macro option:selected").text();
             if (tipmacro == '1' || $("#Macro option:selected").val() == 1) {
                    $("#trMicro").show();
                    $('#Micro').append('<option value= 0 >Seleccione micro</option>');
                    $('#Micro').append('<option value= 1 >Sesión Virtual</option>'); 
                    $('#Micro').append('<option value= 2 >Sesión Presencial</option>');
                } else if (tipmacro == '2' || $("#Macro option:selected").val() == 2) {
                    $("#trMicro").show();
                    $('#Micro').append('<option value= 0 >Seleccione micro</option>');
                    $('#Micro').append('<option value= 1 >Sesión Virtual</option>'); 
                    $('#Micro').append('<option value= 2 >Sesión Presencial</option>');
                } else if (tipmacro == '4' || $("#Macro option:selected").val() == 4) {
                    $("#trMicro").show();
                    $('#Micro').append('<option value= 0 >Seleccione micro</option>');
                    $('#Micro').append('<option value= 3 >Verificación Promesa</option>'); 
                }
                 else if (tipmacro == '5' || $("#Macro option:selected").val() == 5) {
                    $("#trMicro").show();
                    $('#Micro').append('<option value= 0 >Seleccione micro</option>');
                    $('#Micro').append('<option value= 3 >Verificación Promesa</option>'); 
                }
    ...
    <table class="formulario" style="width:100%;">        
        ...
        <tbody>
                ...
                <evo:DatosCliente_DropDownList ID="proceso" runat="server" Clave="Proceso" 
                        ...
                        ValueStyle-Width="85%" Enabled="False">
                        <asp:ListItem Selected="True"></asp:ListItem>
                        <asp:ListItem Value="1. Sheets Promesas">1. Sheets Promesas</asp:ListItem>
                        <asp:ListItem>2. Promesas TELG</asp:ListItem>
                </evo:DatosCliente_DropDownList> 
        ...
        <tbody>
            ...
            <tr id="trMicro">
                <td class="style4" 
                    ...
                    style="border: 1px solid #ed7203; padding: 5px; color: #249e6b; font-weight: bold; font-size: 14px; vertical-align: middle;">
                    Tipificacion Micro:<select id="Micro" name="idMicro" style="width: 100%" >
                    </select></td>
                </tr>
            <tr>
                <td class="style4" 
            ...
            <tr>
                <td class="campoti" style="text-align: center" >
                    ...
                    <input id="Button9" onclick="finalizar()" 
                        style="font-size: 12px; background-color: #249E6B; width: 200px; height: 40px; background-image: none; font-weight: bold; margin-right: 0;" 
                        type="button" value="FINALIZAR" /><input id="Button10"
                        style="font-size: 12px; background-color: #249E6B; width: 200px; height: 40px; background-image: none; font-weight: bold; margin-right: 0;" 
                        type="button" value="ENCUESTA" onclick="Encuesta()"  onclick="return Button10_onclick()" /></td>
            </tr>
        </tbody>
    </table>            
