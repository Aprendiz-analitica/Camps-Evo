<%@ Page language="VB" %>
 ...
 <%
     ...
     Dim IdOriginal As String = Request("doc_fechasignacion")
     Dim Texto1 As String = Request("doc_fechasignacion_date")
     Dim IdOriginalNew As String = IdOriginal + "-" + Texto1
     ...
     Try
         ...
         If IsNumeric(Gestion.Transaccion.Ani) Then
             Telefono = Gestion.Transaccion.Ani
         Else
             Telefono = "00000000"
         End If

         IdSujeto = Clientes.AltaCliente(Gestion.Campanya.IdCampanya, "1", IdOriginalNew, Nombre, Apellido1, texto1:=Texto1, tipId:=0, localizableDesde:=0, localizableHasta:=2359, telefono:=Telefono)
