...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="formulario" style="width:70%;">        
        ...
        <tbody>            
            <tr>
                <td style="border: 2px solid #ed7203;  font-weight: bold; font-size: 16px; " 
                    class="style3">
                ...
                <td 
                    style="border: 2px solid #ed7203; font-weight: bold; font-size: 16px; " 
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203; text-align:center;  font-weight: bold; font-size: 16px;" 
                    ...
                    <input id="Button9" type="button" value="FINALIZAR" onclick="insertarpqrs()" 
                        style="border: 1px ridge #ed7203; color: #ffffff; font-size: 16px; background-color: #249E6B; width: 220px; height: 50px; background-image: none;" /></td>
                <td style="padding: 10px; border: 2px solid #ed7203; text-align:center; font-weight: bold; font-size: 16px;" 
                    colspan="2">
                    <input id="Button10" type="button" value="GUARDAR Y CONTINUAR" 
                        onclick="insertarpqrsgyc()" 
                        style="border: 1px ridge #ed7203; color: #ffffff; font-size: 16px; background-color: #249E6B; width: 220px; height: 50px; background-image: none; white-space: normal;" /></td>
            </tr>
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203; text-align:center; font-weight: bold; font-size: 16px;" 
                    colspan="2">
