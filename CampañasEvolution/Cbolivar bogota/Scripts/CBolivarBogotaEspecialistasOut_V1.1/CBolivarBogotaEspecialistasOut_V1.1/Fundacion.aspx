...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <table class="formulario" style="width:70%;">        
        ...
        <tbody>            
            <tr>
                <td style="border: 2px solid #ed7203; font-weight: bold; font-size: 16px; width: 200px;" 
                    class="style3">
            ...
            <tr>
                ...
                <td 
                    style="border: 2px solid #ed7203;  font-weight: bold; font-size: 16px; width: 200px;" 
                    class="style3" colspan="2">
            ...
            <tr>
                ...
                <td style="padding: 10px; border: 2px solid #ed7203; font-weight: bold; font-size: 16px; "colspan="2">
                    area / Programa:<br />
...
<asp:ListItem Value="Chat">Chat </asp:ListItem>
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203; font-weight: bold; font-size: 16px; ">
                    ...
                    <asp:DropDownList ID="t4" runat="server" ForeColor="Black" Width="250px">
                                            <asp:ListItem></asp:ListItem>
...
<asp:ListItem Value="Parques de Bolivar Barranquilla">Parques de Bolivar Barranquilla </asp:ListItem>
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203; font-weight: bold; font-size: 16px;" 
                    ...
                    <asp:DropDownList ID="t5" runat="server" Width="100%" ForeColor="Black">
                                            <asp:ListItem></asp:ListItem>
...
<asp:ListItem Value="Suspender inscripcion a la convocatoria">Suspender inscripcion a la convocatoria </asp:ListItem>
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203; font-weight: bold; font-size: 16px;">
                    Se escalaria a:<br />
                    <asp:DropDownList ID="t6" runat="server" Width="250px" ForeColor="Black">
                                            <asp:ListItem></asp:ListItem>
...
<asp:ListItem Value="YanebiTamayo">YanebiTamayo </asp:ListItem>
                ...
                <td style="padding: 10px; border: 2px solid #ed7203; font-weight: bold; font-size: 16px;" 
                    colspan="2">
                    Aplicativo:<br />
                    <asp:DropDownList ID="t7" runat="server" Width="250px" ForeColor="Black">
                                            <asp:ListItem></asp:ListItem>
...
<asp:ListItem Value="Salesforce">Salesforce </asp:ListItem>
                ...
                <td style="padding: 10px; border: 2px solid #ed7203;  font-weight: bold; font-size: 16px;">
                    ...
                    <asp:DropDownList ID="t8" runat="server" Width="250px" ForeColor="Black">
                                            <asp:ListItem></asp:ListItem>
...
<asp:ListItem Value="semana">semana </asp:ListItem>
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203;  font-weight: bold; font-size: 16px;" 
                    colspan="4">
                    Descripcion:<br />
                    <asp:TextBox ID="Descripcion" runat="server" Width="100%" Height="50px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="border: 2px solid #ed; text-align:center; height:80px;" 
                    colspan="2">
