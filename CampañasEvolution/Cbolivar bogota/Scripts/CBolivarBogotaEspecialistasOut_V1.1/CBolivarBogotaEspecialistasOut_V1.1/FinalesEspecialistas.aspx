...
<script type="text/javascript">
    ...
    function Transf_Encuesta() {
        agentapi.TransferActiveCall('6040');
  ...
  $(document).ready(function() {
    ...
    var settings = {
           ...
           $.ajax(settings).done(function (response) {
            ...
            var momentos = {
                        "url": url+"/webservicefenalco/cbolivarbgta/listadomomentosesp",
                        "method": "POST",
                        "timeout": 0,
                        "headers": {
    ...
    function llenarNecesidad(idMomento) {
                ...
                var temp;
                var necesidades = {
                  "url": url+"/webservicefenalco/cbolivarbgta/consultarnecesidadpormaestroesp",
                  "method": "POST",
                  "timeout": 0,
                  "headers": {
                    "Authorization": "Bearer "+ token,
        ...
        <tbody>  
            <tr>
                <th style="border: 2px hidden #ed7203; text-align:center; background-color: #249E6B; font-size: 20px; color: #ffffff; font-weight: bold; " 
                    align="center" class="style9" colspan="4">
            ...
            <tr>
                <th style="border: 2px solid #ed7203; text-align:center; background-color: #249E6B; font-size: 20px; color: #ffffff; " 
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203;  font-size: 16px; font-weight: bold;" 
                    colspan="4">
                    Momento:<br />
            ...
            <tr>
                <td style="padding: 10px; border: 2px solid #ed7203; text-align:center;  font-weight: bold; font-size: 16px;" 
                    ...
                    <input id="Button9" type="button" value="FINALIZAR" onclick="insertarpqrs()" 
                        style="border: 1px ridge #249E6B; color: #ffffff; font-size: 16px; background-color: #249E6B; width: 150px; height: 50px; background-image: none;" onclick="return Button9_onclick()"/></td>               
            </tr>
