<%@ Page language="VB" %>
 ...
 <%
     ...
     Dim Texto1 As String = Request("NumGarantia")
     ...
     Try
         ...
         IdSujeto = Clientes.AltaCliente(Gestion.Campanya.IdCampanya, "1", IdOriginal, Nombre, Apellido1, texto1:=Texto1, tipId:=0, localizableDesde:=0, localizableHasta:=2359, telefono:=Telefono)
