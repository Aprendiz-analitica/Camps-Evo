...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="formulario" style="width:100%;">        
        ...
        <tbody>            
            ...
            <tr>
                <td style="border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 14px; padding-bottom: 5px;" 
                    class="style2">
                    Origen caso:<br />
            ...
            <tr>
                <td style="border: 1px solid #2b8b4b; color: #2b8b4b; font-weight: bold; font-size: 14px; width: 603px; padding-bottom: 5px;" 
